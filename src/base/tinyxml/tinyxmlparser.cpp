                ...
                if (encoding == TIXML_ENCODING_UTF8)
                {
                    if (*(p + 1) && *(p + 2))
                    {
                        ...
                        if (*(pU + 1) == TIXML_UTF_LEAD_1 && *(pU + 2) == TIXML_UTF_LEAD_2)
                        {
                            ...
                            if (*(pU + 1) == 0xbfU && *(pU + 2) == 0xbeU)
                            {
                                p += 3;
                            }
                            else
                                if (*(pU + 1) == 0xbfU && *(pU + 2) == 0xbfU)
                                {
                                    p += 3;
                                }
                                else
    ...
    while (p && *p)
    {
                ...
                && node->ToDeclaration())
        {
            ...
            if (*enc == 0)
            {
                ...
                if (StringEqual(enc, "UTF-8", true, TIXML_ENCODING_UNKNOWN))
                {
                    encoding = TIXML_ENCODING_UTF8;
                }
                else
                    if (StringEqual(enc, "UTF8", true, TIXML_ENCODING_UNKNOWN))
                    {
