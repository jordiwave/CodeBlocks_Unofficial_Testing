...
public:
    ...
    /* CHANGEBAR begin */
    void DeleteUndoHistory(bool collectChangeHistory=false)
    {
        cb.DeleteUndoHistory(collectChangeHistory);
    }
    /* CHANGEBAR end */
    ...
    /* CHANGEBAR begin */
    int GetChanged(Sci::Line line)
    {
        return cb.GetChanged(line);
    }
    /* CHANGEBAR end */
    ...
    Sci::Position GetEndStyled() const
    {
        return endStyled;
    }
