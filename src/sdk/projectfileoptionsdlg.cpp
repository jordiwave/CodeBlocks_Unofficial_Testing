 ...
 *
 * $Revision: 12656 $
 * $Id: projectfileoptionsdlg.cpp 12656 2022-01-16 09:56:14Z wh11204 $
 * $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/sdk/projectfileoptionsdlg.cpp $
 */
    ...
    // We are not in a multiple line comment
        ...
        if (!multi_line_comment)
        {
            ...
            // First comment sign found is a multi-line comment begin sign
                ...
                if (first_multi_line_comment_begin > -1)
                {
