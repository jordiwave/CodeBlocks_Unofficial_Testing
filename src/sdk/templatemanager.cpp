 ...
 *
 * $Revision: 12605 $
 * $Id: templatemanager.cpp 12605 2021-12-22 08:53:19Z wh11204 $
 * $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/sdk/templatemanager.cpp $
 */
...
cbProject * TemplateManager::NewProjectFromUserTemplate(NewFromTemplateDlg & dlg, wxString * pFilename)
{
    ...
    if (path.IsEmpty())
    {
        ...
        if (path.Mid(path.Length() - 1) == wxFILE_SEP_PATH)
        {
            path.RemoveLast();
        }
