...
FileType FileTypeOf(const wxString & filename)
{
       ...
       )
    {
        ...
        if (ext.IsSameAs(FileFilters::TPP_EXT) ||
           ...
           )
        {
               ...
               )
            {
                ...
                if (ext.IsSameAs(FileFilters::CODEBLOCKS_EXT))
                {
                    return ftCodeBlocksProject;
                }
                else
                    if (ext.IsSameAs(FileFilters::WORKSPACE_EXT))
                    {
                        return ftCodeBlocksWorkspace;
                    }
                    else
                        if (ext.IsSameAs(FileFilters::DEVCPP_EXT))
                        {
                            return ftDevCppProject;
                        }
                        else
                            if (ext.IsSameAs(FileFilters::MSVC6_EXT))
                            {
                                return ftMSVC6Project;
                            }
                            else
                                if (ext.IsSameAs(FileFilters::MSVC7_EXT))
                                {
                                    return ftMSVC7Project;
                                }
                                else
                                    if (ext.IsSameAs(FileFilters::MSVC10_EXT))
                                    {
                                        return ftMSVC10Project;
                                    }
                                    else
                                        if (ext.IsSameAs(FileFilters::MSVC6_WORKSPACE_EXT))
                                        {
                                            return ftMSVC6Workspace;
                                        }
                                        else
                                            if (ext.IsSameAs(FileFilters::MSVC7_WORKSPACE_EXT))
                                            {
                                                return ftMSVC7Workspace;
                                            }
                                            else
                                                if (ext.IsSameAs(FileFilters::XCODE1_EXT))
                                                {
                                                    return ftXcode1Project;    // Xcode 1.0+ (Mac OS X 10.3)
                                                }
                                                else
                                                    if (ext.IsSameAs(FileFilters::XCODE2_EXT))
                                                    {
                                                        ...
                                                        if (ext.IsSameAs(FileFilters::OBJECT_EXT))
                                                        {
                                                            ...
                                                            if (ext.IsSameAs(FileFilters::XRCRESOURCE_EXT))
                                                            {
                                                                return ftXRCResource;
                                                            }
                                                            else
                                                                if (ext.IsSameAs(FileFilters::RESOURCE_EXT))
                                                                {
                                                                    return ftResource;
                                                                }
                                                                else
                                                                    if (ext.IsSameAs(FileFilters::RESOURCEBIN_EXT))
                                                                    {
                                                                        return ftResourceBin;
                                                                    }
                                                                    else
                                                                        if (ext.IsSameAs(FileFilters::STATICLIB_EXT))
                                                                        {
                                                                            return ftStaticLib;
                                                                        }
                                                                        else
                                                                            if (ext.IsSameAs(FileFilters::DYNAMICLIB_EXT))
                                                                            {
                                                                                return ftDynamicLib;
                                                                            }
                                                                            else
                                                                                if (ext.IsSameAs(FileFilters::NATIVE_EXT))
                                                                                {
                                                                                    return ftNative;
                                                                                }
                                                                                else
                                                                                    if (ext.IsSameAs(FileFilters::EXECUTABLE_EXT))
                                                                                    {
                                                                                        return ftExecutable;
                                                                                    }
                                                                                    else
                                                                                        if (ext.IsSameAs(FileFilters::XML_EXT))
                                                                                        {
                                                                                            return ftXMLDocument;
                                                                                        }
                                                                                        else
                                                                                            if (ext.IsSameAs(FileFilters::SCRIPT_EXT))
                                                                                            {
                                                                                                return ftScript;
                                                                                            }
...
bool IsSuffixOfPath(wxFileName const & suffix, wxFileName const & path)
{
    ...
    for (int i = suffixDirArray.GetCount() - 1; i >= 0; i--)
    {
        ...
        // the corresponding directories of the two paths differ
            ...
            if (suffixDirArray[i] != pathDirArray[j])
            {
                return false;
            }
