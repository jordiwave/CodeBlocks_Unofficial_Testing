 ...
 *
 * $Revision: 12200 $
 * $Id: todolist.cpp 12200 2020-09-14 18:19:42Z fuscated $
 * $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/todo/todolist.cpp $
 */
...
void ToDoList::OnAddItem(cb_unused wxCommandEvent & event)
{
    ...
    if ((CmtType == tdctWarning) || (CmtType == tdctError))
    {
        ...
        if (CmtType == tdctLine || (CmtType == tdctDoxygenLine))
        {
            wxString lc;
