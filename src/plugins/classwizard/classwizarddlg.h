...
public:
    ...
    // access
    const wxString& GetHeaderFilename()         const
    {
        return m_Header;
    }
    bool  IsValidImplementationFilename()       const
    {
        return m_GenerateImplementation && m_Implementation != _T("");
    }
    const wxString& GetImplementationFilename() const
    {
        return m_Implementation;
    }
    bool  AddPathToProject()                    const
    {
        return m_AddPathToProject;
    }
    wxString GetIncludeDir();

private:
    struct MemberVar_impl
    {
        wxString Typ;
        wxString Var;
        wxString Get;
