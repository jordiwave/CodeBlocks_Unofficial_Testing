									...
									<object class="wxStaticBoxSizer">
										...
										<object class="sizeritem">
											<object class="wxCheckBox" name="chkAddDoxgenComment">
												<label>Add doxygen comment, when implementing the function method</label>
											</object>
											<flag>wxTOP|wxLEFT|wxRIGHT|wxEXPAND</flag>
											<border>5</border>
										</object>
										...
										<object class="sizeritem">
											<object class="wxStaticText" name="ID_STATICTEXT1">
												<label>Delay for auto-code-completion-kick-in when typing </label>
											</object>
										...
										<object class="sizeritem">
											<object class="wxBoxSizer">
												...
												<object class="sizeritem">
													...
													<flag>wxTOP|wxRIGHT|wxALIGN_TOP</flag>
													<border>5</border>
												</object>
											</object>
							...
							<object class="wxBoxSizer">
								...
								<object class="sizeritem">
									<object class="wxStaticBoxSizer">
										...
										<object class="sizeritem">
											<object class="wxCheckBox" name="chkPlatformCheck">
												<label>Enable platform checks when collecting include folders to parse</label>
												<checked>1</checked>
											</object>
											<flag>wxBOTTOM|wxLEFT|wxRIGHT|wxALIGN_LEFT</flag>
											<border>5</border>
									...
									<object class="wxStaticBoxSizer">
										...
										<object class="sizeritem">
											<object class="wxStaticText" name="ID_STATICTEXT8">
												<label>File extensions to parse as header files (separated by comma):</label>
											</object>
											<flag>wxTOP|wxLEFT|wxRIGHT|wxALIGN_LEFT</flag>
											<border>5</border>
										</object>
										<object class="sizeritem">
											<object class="wxTextCtrl" name="txtCCFileExtHeader">
												<value>h,hpp,hxx,hh,h++,tcc,xpm</value>
											</object>
											<flag>wxALL|wxEXPAND</flag>
											<border>5</border>
										</object>
										...
										<object class="sizeritem">
											<object class="wxStaticText" name="ID_STATICTEXT9">
												<label>File extensions to parse as source files (separated by comma):</label>
											</object>
											<flag>wxTOP|wxLEFT|wxRIGHT|wxALIGN_LEFT</flag>
											<border>5</border>
										</object>
										...
										<object class="sizeritem">
											<object class="wxFlexGridSizer">
												...
												<object class="sizeritem">
													...
													<flag>wxTOP|wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL</flag>
													<border>5</border>
													<option>1</option>
												</object>
												<object class="sizeritem">
