...
#ifndef CBMARKDOWN_H_INCLUDED
#define CBMARKDOWN_H_INCLUDED
...
class cbMarkdown : public cbPlugin
{
    public:
        /** Constructor. */
        cbMarkdown();
        ...
        void OnEditorSwitched(CodeBlocksEvent & event);
