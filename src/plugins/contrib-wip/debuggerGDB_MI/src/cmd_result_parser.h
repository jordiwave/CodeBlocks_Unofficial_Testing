...
namespace dbg_mi
{
    ...
    class ResultValue
    {
        ...
        public:
            ...
            void SetSimpleValue(wxString const & value)
            {
                assert(m_type == Simple);
                m_value.simple = value;
            }
            ...
            wxString const & GetSimpleValue() const
            {
                assert(m_type == Simple);
        ...
        private:
            Container::iterator FindTupleValue(wxString const & name)
            {
            ...
            Container::const_iterator FindTupleValue(wxString const & name) const
            {
