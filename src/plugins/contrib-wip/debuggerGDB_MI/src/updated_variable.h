...
class UpdatedVariable
{
    ...
    public:
        ...
        wxString const & GetValue() const
        {
            return m_value;
        }
        wxString const & GetNewType() const
        {
            return m_new_type;
        }
        bool TypeChanged() const
        {
            return m_type_changed;
        }
        bool HasValue() const
        {
            return m_has_value;
        }
        int GetNewNumberOfChildren() const
        {
            return m_new_num_children;
        }
        bool HasNewNumberOfChildren() const
        {
            return m_new_num_children != -1;
        }
        bool HasMore() const
        {
            return m_has_more;
