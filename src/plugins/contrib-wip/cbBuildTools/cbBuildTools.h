...
#ifndef CBBUILDTOOLS_H_INCLUDED
#define CBBUILDTOOLS_H_INCLUDED
...
class cbBuildTools : public cbPlugin
{
    public:
        /** Constructor. */
        cbBuildTools();
        /** Destructor. */
        virtual ~cbBuildTools();
    ...
    private:
        ...
        static const long ID_MENU_BUILD_TOOLS_VIEW;
        static const long ID_MENU_SHOW_BUILD_TARGETS_PANEL;


        DECLARE_EVENT_TABLE();
};

#endif // CBBUILDTOOLS_H_INCLUDED
