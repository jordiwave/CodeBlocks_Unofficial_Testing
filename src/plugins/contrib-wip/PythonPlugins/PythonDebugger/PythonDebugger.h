...
class PyBreakpoint: public cbBreakpoint
{
    public:
        ...
        wxString GetLineString() const
        {
            return wxString::Format(wxT("%i"), m_line);
        }
...
class PythonDebugger : public cbDebuggerPlugin
{
    public:
        ...
        {
            cb::shared_ptr<const cbThread> p(new cbThread());
            return p;
        }
        ...
        {
            return m_TimerPollDebugger.IsRunning();
        }
        ...
        {
            return m_DebuggerActive;    /** Is the plugin currently debugging? */
        }
        ...
        {
            return new PyDebuggerConfiguration(config);
        }
        ...
        {
            return 0;    /** Return plugin's configuration panel for projects.*/
        }
