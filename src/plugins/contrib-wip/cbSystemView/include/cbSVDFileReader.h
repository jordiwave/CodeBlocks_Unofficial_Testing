...
class SVDXMLnode
{
    public:
        SVDXMLnode()    {};
        virtual ~SVDXMLnode()   {};
        virtual int ReadFromNode(TiXmlElement * node)
        {
            return 0;
        };
        virtual int WriteToNode(TiXmlElement * node)
        {
            return 0;
        };
};
...
class SVDSAURegion : public SVDXMLnode
{
    public:
        ...
        int WriteToNode(TiXmlElement * node)
        {
            return 0;
        };
        ...
        svd_address GetBaseAddress()    const
        {
            return m_base;
        };
        void  SetBaseAddress(svd_address base)
        {
            m_base = base;
        };

        svd_address GetLimit()    const
        {
            return m_limit;
        };
        void  SetLimit(svd_address limit)
        {
            m_limit = limit;
        };

        svdRegionAccessLevel    GetAccessLevel()
        {
            return m_access;
        };
        void  SetAccessLevel(svdRegionAccessLevel acc)
        {
            m_access = acc;
        };
...
class SVDSAURegionsConfig : public SVDXMLnode
{
    public:
        ...
        svdProtectionLevel GetProtectionLvl()
        {
            return m_ProtectionWhenDisabled;
        };
        void SetProtectionLvl(svdProtectionLevel lvl)
        {
            m_ProtectionWhenDisabled = lvl;
        };

        std::vector<SVDSAURegion>::iterator GetRegionsBegin()
        {
            return m_regions.begin();
        };
        std::vector<SVDSAURegion>::iterator GetRegionsEnd()
        {
            return m_regions.end();
        };
        size_t GetRegionsCount()
        {
            return m_regions.size();
        };
        SVDSAURegion GetRegionsItem(size_t i)
        {
            return m_regions[i];
        };
...
class SVDArray : public SVDXMLnode
{
    public:
        ...
        svd_address  GetDimIncrement()
        {
            return m_dimIncrement;
        };
        wxString     GetDimName()
        {
            return m_dimName;
        ...
        std::vector<wxString>::iterator GetDimIndexBegin()
        {
            return m_dimIndex.begin();
        };
        std::vector<wxString>::iterator GetDimIndexEnd()
        {
            return m_dimIndex.end();
        };
        size_t GGetDimIndexCount()
        {
            return m_dimIndex.size();
        };
        wxString GetDimIndexItem(size_t i)
        {
            return m_dimIndex[i];
        };
...
class SVDRegisterProperties : public SVDXMLnode
{
    public:
        ...
        svdAccessRight GetAccessRight() const
        {
            return m_access;
        };
        wxString       GetProtection()  const
        {
            return m_protection;
        };
        uint64_t       GetResetValue()  const
        {
            return m_resetValue;
        };
        uint64_t       GetResetMask()   const
        {
            return m_resetMask;
        };
...
class SVDRegisterBase : public SVDRegisterProperties, public SVDArray
{
    public:
        ...
        {
            return m_addressOffset = offset * m_dimIncrement;
        };

        svd_address GetAddressOfset() const
        {
            return m_addressOffset;
        };
        void SetAddressOfset(svd_address off)
        {
            m_addressOffset = off;
        };
...
class SVDBitRange : public SVDXMLnode
{
    public:
        ...
        {
            return (static_cast<uint64_t>(-(m_BitWidth != 0)) & (static_cast<uint64_t>(-1) >> ((sizeof(uint64_t) * 8 /*CHAR_BIT*/) - m_BitWidth))) << m_BitOffset;     // Kudos to https://stackoverflow.com/a/28703383
        }
        unsigned int GetLSB()    const
        {
            return m_BitOffset;
        };
        unsigned int GetMSB()    const
        {
            return m_BitOffset + m_BitWidth - 1;
        };
        wxString     GetRange()  const
        {
            return wxString::Format(wxT("[%d;%d]"), GetMSB(), GetLSB());
        };
        ...
        void SetLSB(unsigned int lsb)
        {
            m_BitOffset = lsb;
        };
        void SetMSB(unsigned int msb)
        {
            m_BitWidth = msb - m_BitOffset;
        };
        void SetLSBMSB(unsigned int lsb, unsigned int msb)
        {
            m_BitOffset = lsb;
            m_BitWidth = msb - lsb + 1;
        };
...
class SVDFieldsBase : public SVDRegisterBase
{
    public:
        ...
        SVDWriteConstrains    GetWriteConstraint() const
        {
            return m_writeConstraint;
        };
        svdWriteModifications GetModifiedWriteValues() const
        {
            return m_modifiedWriteValues;
        };
        svdReadModifications  GetReadAction() const
        {
            return m_readAction;
        };

        void SetWriteConstraint(SVDWriteConstrains wc)
        {
            m_writeConstraint = wc;
        };
        void SetModifiedWriteValues(svdWriteModifications wm)
        {
            m_modifiedWriteValues = wm;
        };
        void SetReadAction(svdReadModifications rm)
        {
            m_readAction = rm;
        };
...
class SVDEnumeratedValues : public SVDXMLnode
{
    public:
        ...
        wxString GetHeaderEnumName() const
        {
            return m_headerEnumName;
        };
        svdEnumUsage GetUsage() const
        {
            return m_usage;
        }

        std::vector<std::shared_ptr<SVDEnumeratedValue>>::iterator GetValuesBegin()
        {
            return m_values.begin();
        };
        std::vector<std::shared_ptr<SVDEnumeratedValue>>::iterator GetValuesEnd()
        {
            return m_values.end();
        };
...
class SVDPeriphery : public SVDRegisterProperties, public SVDArray
{
    public:
        ...
        int CalculateOffset(int offset)
        {
            return m_baseAddress = offset * m_dimIncrement;
        };
        ...
        wxString GetAlternativePath() const
        {
            return m_alternatePeripherial;
        };
        wxString GetGroupName() const
        {
            return m_groupName;
        };
        wxString GetPrependToName() const
        {
            return m_prependToName;
        };
        wxString GetAppendToName() const
        {
            return m_appendToName;
        };
        wxString GetHeaderStructName() const
        {
            return m_headerStructName;
        };
        wxString GetDisableCondition() const
        {
            return m_disableCondition;
        };

        void SetDerivedFrom(wxString der)
        {
            m_derivedFrom = der;
        };
        ...
        void SetAlternativePath(wxString alt)
        {
            m_alternatePeripherial = alt;
        };
        void SetGroupName(wxString groupn)
        {
            m_groupName = groupn;
        };
        void SetPrependToName(wxString prepend)
        {
            m_prependToName = prepend;
        };
        void SetAppendToName(wxString append)
        {
            m_appendToName = append;
        };
        void SetHeaderStructName(wxString name)
        {
            m_headerStructName = name;
        };
        void SetDisableCondition(wxString cond)
        {
            m_disableCondition = cond;
        };
        ...
        void  GetBaseAddress(svd_address addr)
        {
            m_baseAddress = addr;
        };

        std::vector<SVDAddressBlock>::iterator GetAddressBlocksBegin()
        {
            return m_addressBlocks.begin();
        };
        std::vector<SVDAddressBlock>::iterator GetAddressBlocksEnd()
        {
            return m_addressBlocks.end();
        };
        size_t GetAddressBlocksCount()
        {
            return m_addressBlocks.size();
        };

        std::vector<SVDInterrupt>::iterator GetInterruptsBegin()
        {
            return m_interrupts.begin();
        };
        std::vector<SVDInterrupt>::iterator GetInterruptsEnd()
        {
            return m_interrupts.end();
        };
        size_t GetInterruptsSize()
        {
            return m_interrupts.size();
        };

        std::vector<std::shared_ptr<SVDRegisterBase>>::iterator GetRegistersBegin()
        {
            return m_registers.begin();
        };
        std::vector<std::shared_ptr<SVDRegisterBase>>::iterator GetRegistersEnd()
        {
...
class SVDDevice : public SVDRegisterProperties
{
    public:
        ...
        wxString        GetHeaderSystemFilename()
        {
            return m_headerSystemFilename;
        };
        wxString        GetHeaderDefinitionsPrefix()
        {
            return m_headerDefinitionsPrefix;
        };
        unsigned int    GetAddressUnitBits()
        {
            return m_AddressUnitBits;
        };
        ...
        void SetVendor(wxString vendor)
        {
            m_vendor = vendor;
        };
        void SetVendorID(wxString vendorId)
        {
            m_vendorID = vendorId;
        };
        void SetSeries(wxString series)
        {
            m_series = series;
        };
        ...
        void SetLicenseText(wxString text)
        {
            m_licenseText = text;
        };
        void SetHeaderSystemFilename(wxString header)
        {
            m_headerSystemFilename = header;
        };
        void SetHeaderDefinitionsPrefix(wxString headerPrefix)
        {
            m_headerDefinitionsPrefix = headerPrefix;
        };
        void SetAddressUnitBits(unsigned int unitBits)
        {
            m_AddressUnitBits = unitBits;
        };
        ...
        SVDPeriperyVector::iterator GetPeriperyBegin()
        {
            return m_peripherals.begin();
        };
        SVDPeriperyVector::iterator GetPeriperyEnd()
        {
            return m_peripherals.end();
        };
        SVDPeriperyVector::value_type GetPeriperyAtIndex(size_t i)
        {
            return m_peripherals[i];
        };
        size_t GetPeriperyCount()
        {
...
bool inline SVDConvertFromChar(const char * txt, svdAddressBlockUsage & type)
{
    if (txt)
    {
        ...
        if (tmp == wxT("registers") || tmp == wxT("0"))
        {
            ...
            if (tmp == wxT("buffer") || tmp == wxT("1"))
            {
                type = SVD_USAGE_BUFFER;
            }
            else
                if (tmp == wxT("buffer") || tmp == wxT("2"))
                {
...
bool inline SVDConvertFromChar(const char * txt, svdAccessRight & type)
{
    if (txt)
    {
        ...
        if (tmp == wxT("read-only"))
        {
            ...
            if (tmp == wxT("write-only"))
            {
                type = SVD_ACCESS_WRITE;
            }
            else
                if (tmp == wxT("read-write"))
                {
                    type = SVD_ACCESS_READ_WRITE;
                }
                else
                    if (tmp == wxT("writeOnce"))
                    {
                        type = SVD_ACCESS_WRITE_ONCE;
                    }
                    else
                        if (tmp == wxT("read-writeOnce"))
                        {
