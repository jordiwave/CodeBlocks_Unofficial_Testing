...
void cbDiffEditor::Copy()
{
    diffctrl_->Copy();
}
void cbDiffEditor::ClearHistory()
{
    diffctrl_->ClearHistory();
}
bool cbDiffEditor::CanUndo() const
{
    return diffctrl_->CanUndo();
}
bool cbDiffEditor::CanRedo() const
{
    return diffctrl_->CanRedo();
}
bool cbDiffEditor::HasSelection() const
{
    return diffctrl_->HasSelection();
}
bool cbDiffEditor::CanPaste() const
{
    return diffctrl_->CanPaste();
}
bool cbDiffEditor::CanSelectAll() const
{
    return diffctrl_->CanSelectAll();
}
void cbDiffEditor::SelectAll()
{
    diffctrl_->SelectAll();
}
...
void cbDiffEditor::CopyToLeft()
{
    diffctrl_->CopyToLeft();
}
bool cbDiffEditor::CanCopyToLeft()
{
    return diffctrl_->CanCopyToLeft();
}
void cbDiffEditor::CopyToRight()
{
    diffctrl_->CopyToRight();
}
bool cbDiffEditor::CanCopyToRight()
{
    return diffctrl_->CanCopyToRight();
}
void cbDiffEditor::CopyToLeftNext()
{
    diffctrl_->CopyToLeftNext();
}
bool cbDiffEditor::CanCopyToLeftNext()
{
    return diffctrl_->CanCopyToLeftNext();
}
void cbDiffEditor::CopyToRightNext()
{
    diffctrl_->CopyToRightNext();
}
bool cbDiffEditor::CanCopyToRightNext()
{
    return diffctrl_->CanCopyToRightNext();
}
