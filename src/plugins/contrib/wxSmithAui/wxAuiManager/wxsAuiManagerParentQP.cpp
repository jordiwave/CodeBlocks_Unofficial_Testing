    ...
    m_Extra(Extra)
{
    ...
    FlexGridSizer4->Add(StaticText4, 1, wxALIGN_CENTER_VERTICAL, 5);
    ...
    FlexGridSizer4->Add(Name, 1, wxEXPAND, 5);
    ...
    FlexGridSizer4->Add(Visible, 1, wxEXPAND, 5);
    ...
    FlexGridSizer4->Add(Resizable, 1, wxEXPAND, 5);
    ...
    FlexGridSizer4->Add(Movable, 1, wxEXPAND, 5);
    ...
    FlexGridSizer4->Add(Floatable, 1, wxEXPAND, 5);
    ...
    FlexGridSizer4->Add(PaneBorder, 1, wxEXPAND, 5);
    ...
    FlexGridSizer4->Add(DestroyOnClose, 1, wxEXPAND, 5);
    StaticBoxSizer4->Add(FlexGridSizer4, 1, wxEXPAND, 5);
    FlexGridSizer1->Add(StaticBoxSizer4, 1, wxLEFT | wxRIGHT | wxEXPAND, 5);
    ...
    StaticBoxSizer7->Add(StandardPane, 1, wxEXPAND, 5);
    FlexGridSizer1->Add(StaticBoxSizer7, 1, wxLEFT | wxRIGHT | wxEXPAND, 5);
    ...
    FlexGridSizer7->Add(Caption, 1, wxEXPAND, 5);
    ...
    FlexGridSizer7->Add(CaptionVisible, 1, wxEXPAND, 5);
    FlexGridSizer5->Add(FlexGridSizer7, 1, wxEXPAND, 5);
    ...
    FlexGridSizer6->Add(MinimizeButton, 1, wxEXPAND, 5);
    ...
    FlexGridSizer6->Add(PinButton, 1, wxEXPAND, 5);
    ...
    FlexGridSizer6->Add(MaximizeButton, 1, wxEXPAND, 5);
    ...
    FlexGridSizer6->Add(CloseButton, 1, wxEXPAND, 5);
    StaticBoxSizer5->Add(FlexGridSizer6, 1, wxEXPAND, 5);
    FlexGridSizer5->Add(StaticBoxSizer5, 1, wxEXPAND, 5);
    StaticBoxSizer3->Add(FlexGridSizer5, 1, wxEXPAND, 5);
    FlexGridSizer1->Add(StaticBoxSizer3, 1, wxLEFT | wxRIGHT | wxEXPAND, 5);
    ...
    BoxSizer2->Add(Docked, 1, wxALIGN_CENTER_VERTICAL, 5);
    ...
    BoxSizer2->Add(DockFixed, 1, wxALIGN_CENTER_VERTICAL, 5);
    FlexGridSizer3->Add(BoxSizer2, 1, wxEXPAND, 5);
    ...
    BoxSizer1->Add(StaticText1, 0, wxRIGHT | wxEXPAND, 5);
    ...
    BoxSizer5->Add(Position, 1, wxEXPAND, 5);
    FlexGridSizer2->Add(BoxSizer5, 1, wxEXPAND, 5);
    ...
    GridSizer1->Add(0, 0, 1, wxALIGN_CENTER_VERTICAL, 5);
    ...
    GridSizer1->Add(DockTop, 1, wxALIGN_CENTER_VERTICAL, 5);
    GridSizer1->Add(0, 0, 1, wxALIGN_CENTER_VERTICAL, 5);
    ...
    GridSizer1->Add(DockLeft, 1, wxALIGN_CENTER_VERTICAL, 5);
    ...
    GridSizer1->Add(DockCenter, 1, wxALIGN_CENTER_VERTICAL, 0);
    ...
    GridSizer1->Add(DockRight, 1, wxALIGN_CENTER_VERTICAL, 5);
    GridSizer1->Add(0, 0, 1, wxALIGN_CENTER_VERTICAL, 5);
    ...
    GridSizer1->Add(DockBottom, 1, wxALIGN_CENTER_VERTICAL, 5);
    StaticBoxSizer2->Add(GridSizer1, 1, wxEXPAND, 0);
    ...
    GridSizer3->Add(0, 0, 1, wxALIGN_CENTER_VERTICAL, 5);
    ...
    GridSizer3->Add(TopDockable, 1, wxALIGN_CENTER_VERTICAL, 5);
    GridSizer3->Add(0, 0, 1, wxALIGN_CENTER_VERTICAL, 5);
    ...
    GridSizer3->Add(LeftDockable, 1, wxALIGN_CENTER_VERTICAL, 5);
    GridSizer3->Add(-1, -1, 1, wxEXPAND, 5);
    ...
    GridSizer3->Add(RightDockable, 1, wxALIGN_CENTER_VERTICAL, 5);
    GridSizer3->Add(0, 0, 1, wxALIGN_CENTER_VERTICAL, 5);
    ...
    GridSizer3->Add(BottomDockable, 1, wxALIGN_CENTER_VERTICAL, 5);
    StaticBoxSizer6->Add(GridSizer3, 1, wxEXPAND, 0);
    BoxSizer3->Add(StaticBoxSizer6, 1, wxEXPAND, 5);
    FlexGridSizer3->Add(BoxSizer3, 1, wxEXPAND, 5);
...
void wxsAuiManagerParentQP::ReadData()
{
    ...
    {
        if (Dockable & wxsAuiDockableProperty::TopDockable)
        {
            TopDockable->   SetValue(true);
        }

        if (Dockable & wxsAuiDockableProperty::BottomDockable)
        {
            BottomDockable->SetValue(true);
        }

        if (Dockable & wxsAuiDockableProperty::LeftDockable)
        {
            LeftDockable->  SetValue(true);
        }

        if (Dockable & wxsAuiDockableProperty::RightDockable)
        {
            RightDockable-> SetValue(true);
        }
    }
...
void wxsAuiManagerParentQP::OnDockDirectionChange(cb_unused wxCommandEvent & event)
{
    ...
    if (DockTop->GetValue() && (m_Extra->m_DockDirection != wxAUI_DOCK_TOP))
    {
        ...
        if (DockBottom->GetValue() && (m_Extra->m_DockDirection != wxAUI_DOCK_BOTTOM))
        {
            ...
            if (DockLeft->GetValue() && (m_Extra->m_DockDirection != wxAUI_DOCK_LEFT))
            {
                ...
                if (DockRight->GetValue() && (m_Extra->m_DockDirection != wxAUI_DOCK_RIGHT))
                {
                    ...
                    if (DockCenter->GetValue() && (m_Extra->m_DockDirection != wxAUI_DOCK_CENTER))
                    {
