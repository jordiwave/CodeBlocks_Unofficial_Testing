...
void FConstruct::GetWords(int i, wxString & word1, wxString & word2, wxString & word3, FCLid & flid) const
{
    ...
    if (word1.IsSameAs("if") && word2.IsSameAs("then") && word3.IsSameAs(wxEmptyString))
    {
        ...
        if (word1.IsSameAs("else") && word2.IsSameAs("if") && word3.IsSameAs("then"))
        {
            flid = fclIf_else_if_then;
        }
        else
            if (word1.IsSameAs("else") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
            {
                flid = fclIf_else;
            }
            else
                if (word1.IsSameAs("end") && word2.IsSameAs("if") && word3.IsSameAs(wxEmptyString))
                {
                    flid = fclIf_end_if;
                }
                else
                    if (word1.IsSameAs("do") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                    {
                        flid = fclDo_do;
                    }
                    else
                        if (word1.IsSameAs("end") && word2.IsSameAs("do") && word3.IsSameAs(wxEmptyString))
                        {
                            flid = fclDo_end_do;
                        }
                        else
                            if (word1.IsSameAs("interface") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                            {
                                flid = fclInterf_interf;
                            }
                            else
                                if (word1.IsSameAs("end") && word2.IsSameAs("interface") && word3.IsSameAs(wxEmptyString))
                                {
                                    flid = fclInterf_end_interf;
                                }
                                else
                                    if (word1.IsSameAs("function") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                    {
                                        flid = fclFun_fun;
                                    }
                                    else
                                        if (word1.IsSameAs("end") && word2.IsSameAs("function") && word3.IsSameAs(wxEmptyString))
                                        {
                                            flid = fclFun_end_fun;
                                        }
                                        else
                                            if (word1.IsSameAs("subroutine") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                            {
                                                flid = fclSub_sub;
                                            }
                                            else
                                                if (word1.IsSameAs("end") && word2.IsSameAs("subroutine") && word3.IsSameAs(wxEmptyString))
                                                {
                                                    flid = fclSub_end_sub;
                                                }
                                                else
                                                    if (word1.IsSameAs("program") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                    {
                                                        flid = fclProg_prog;
                                                    }
                                                    else
                                                        if (word1.IsSameAs("end") && word2.IsSameAs("program") && word3.IsSameAs(wxEmptyString))
                                                        {
                                                            flid = fclProg_end_prog;
                                                        }
                                                        else
                                                            if (word1.IsSameAs("module") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                            {
                                                                flid = fclMod_module;
                                                            }
                                                            else
                                                                if (word1.IsSameAs("end") && word2.IsSameAs("module") && word3.IsSameAs(wxEmptyString))
                                                                {
                                                                    flid = fclMod_end_module;
                                                                }
                                                                else
                                                                    if (word1.IsSameAs("submodule") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                    {
                                                                        flid = fclSubmod_submod;
                                                                    }
                                                                    else
                                                                        if (word1.IsSameAs("end") && word2.IsSameAs("submodule") && word3.IsSameAs(wxEmptyString))
                                                                        {
                                                                            flid = fclSubmod_end_submod;
                                                                        }
                                                                        else
                                                                            if (word1.IsSameAs("select") && word2.IsSameAs("case") && word3.IsSameAs(wxEmptyString))
                                                                            {
                                                                                flid = fclSelectCase_start;
                                                                            }
                                                                            else
                                                                                if (word1.IsSameAs("case") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                {
                                                                                    flid = fclSelectCase_case;
                                                                                }
                                                                                else
                                                                                    if (word1.IsSameAs("case") && word2.IsSameAs("default") && word3.IsSameAs(wxEmptyString))
                                                                                    {
                                                                                        flid = fclSelectCase_case;
                                                                                    }
                                                                                    else
                                                                                        if (word1.IsSameAs("select") && word2.IsSameAs("type") && word3.IsSameAs(wxEmptyString))
                                                                                        {
                                                                                            flid = fclSelectType_start;
                                                                                        }
                                                                                        else
                                                                                            if (word1.IsSameAs("type") && word2.IsSameAs("is") && word3.IsSameAs(wxEmptyString))
                                                                                            {
                                                                                                flid = fclSelectType_type_is;
                                                                                            }
                                                                                            else
                                                                                                if (word1.IsSameAs("class") && word2.IsSameAs("is") && word3.IsSameAs(wxEmptyString))
                                                                                                {
                                                                                                    flid = fclSelectType_class_is;
                                                                                                }
                                                                                                else
                                                                                                    if (word1.IsSameAs("class") && word2.IsSameAs("default") && word3.IsSameAs(wxEmptyString))
                                                                                                    {
                                                                                                        flid = fclSelectType_class_default;
                                                                                                    }
                                                                                                    else
                                                                                                        if (word1.IsSameAs("end") && word2.IsSameAs("select") && word3.IsSameAs(wxEmptyString))
                                                                                                        {
                                                                                                            flid = fclSelect_end;
                                                                                                        }
                                                                                                        else
                                                                                                            if (word1.IsSameAs("select") && word2.IsSameAs("rank") && word3.IsSameAs(wxEmptyString))
                                                                                                            {
                                                                                                                flid = fclSelectRank_start;
                                                                                                            }
                                                                                                            else
                                                                                                                if (word1.IsSameAs("rank") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                {
                                                                                                                    flid = fclSelectRank_rank;
                                                                                                                }
                                                                                                                else
                                                                                                                    if (word1.IsSameAs("rank") && word2.IsSameAs("default") && word3.IsSameAs(wxEmptyString))
                                                                                                                    {
                                                                                                                        flid = fclSelectRank_rank;
                                                                                                                    }
                                                                                                                    else
                                                                                                                        if (word1.IsSameAs("type") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                        {
                                                                                                                            flid = fclType_type;
                                                                                                                        }
                                                                                                                        else
                                                                                                                            if (word1.IsSameAs("end") && word2.IsSameAs("type") && word3.IsSameAs(wxEmptyString))
                                                                                                                            {
                                                                                                                                flid = fclType_end_type;
                                                                                                                            }
                                                                                                                            else
                                                                                                                                if (word1.IsSameAs("enum") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                {
                                                                                                                                    flid = fclEnum_enum;
                                                                                                                                }
                                                                                                                                else
                                                                                                                                    if (word1.IsSameAs("end") && word2.IsSameAs("enum") && word3.IsSameAs(wxEmptyString))
                                                                                                                                    {
                                                                                                                                        flid = fclEnum_end_enum;
                                                                                                                                    }
                                                                                                                                    else
                                                                                                                                        if (word1.IsSameAs("critical") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                        {
                                                                                                                                            flid = fclCritical_critical;
                                                                                                                                        }
                                                                                                                                        else
                                                                                                                                            if (word1.IsSameAs("end") && word2.IsSameAs("critical") && word3.IsSameAs(wxEmptyString))
                                                                                                                                            {
                                                                                                                                                flid = fclCritical_end_critical;
                                                                                                                                            }
                                                                                                                                            else
                                                                                                                                                if (word1.IsSameAs("forall") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                {
                                                                                                                                                    flid = fclForall_forall;
                                                                                                                                                }
                                                                                                                                                else
                                                                                                                                                    if (word1.IsSameAs("end") && word2.IsSameAs("forall") && word3.IsSameAs(wxEmptyString))
                                                                                                                                                    {
                                                                                                                                                        flid = fclForall_end_forall;
                                                                                                                                                    }
                                                                                                                                                    else
                                                                                                                                                        if (word1.IsSameAs("associate") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                        {
                                                                                                                                                            flid = fclAssoc_associate;
                                                                                                                                                        }
                                                                                                                                                        else
                                                                                                                                                            if (word1.IsSameAs("end") && word2.IsSameAs("associate") && word3.IsSameAs(wxEmptyString))
                                                                                                                                                            {
                                                                                                                                                                flid = fclAssoc_end_associate;
                                                                                                                                                            }
                                                                                                                                                            else
                                                                                                                                                                if (word1.IsSameAs("block") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                {
                                                                                                                                                                    flid = fclBlock_block;
                                                                                                                                                                }
                                                                                                                                                                else
                                                                                                                                                                    if (word1.IsSameAs("end") && word2.IsSameAs("block") && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                    {
                                                                                                                                                                        flid = fclBlock_end_block;
                                                                                                                                                                    }
                                                                                                                                                                    else
                                                                                                                                                                        if (word1.IsSameAs("block") && word2.IsSameAs("data") && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                        {
                                                                                                                                                                            flid = fclBlockdata_blockdata;
                                                                                                                                                                        }
                                                                                                                                                                        else
                                                                                                                                                                            if (word1.IsSameAs("end") && word2.IsSameAs("block") && word3.IsSameAs("data"))
                                                                                                                                                                            {
                                                                                                                                                                                flid = fclBlockdata_end_blockdata;
                                                                                                                                                                            }
                                                                                                                                                                            else
                                                                                                                                                                                if (word1.IsSameAs("change") && word2.IsSameAs("team") && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                {
                                                                                                                                                                                    flid = fclTeam_change_team;
                                                                                                                                                                                }
                                                                                                                                                                                else
                                                                                                                                                                                    if (word1.IsSameAs("end") && word2.IsSameAs("team") && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                    {
                                                                                                                                                                                        flid = fclTeam_end_team;
                                                                                                                                                                                    }
                                                                                                                                                                                    else
                                                                                                                                                                                        if (word1.IsSameAs("where") && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                        {
                                                                                                                                                                                            flid = fclWhere_where;
                                                                                                                                                                                        }
                                                                                                                                                                                        else
                                                                                                                                                                                            if (word1.IsSameAs("else") && word2.IsSameAs("where") && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                            {
                                                                                                                                                                                                flid = fclWhere_else_where;
                                                                                                                                                                                            }
                                                                                                                                                                                            else
                                                                                                                                                                                                if (word1.IsSameAs("end") && word2.IsSameAs("where") && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                                {
                                                                                                                                                                                                    flid = fclWhere_end_where;
                                                                                                                                                                                                }
                                                                                                                                                                                                else
                                                                                                                                                                                                    if (word1.IsSameAs("module") && word2.IsSameAs("procedure") && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                                    {
                                                                                                                                                                                                        flid = fclProc_mod_proc;
                                                                                                                                                                                                    }
                                                                                                                                                                                                    else
                                                                                                                                                                                                        if (word1.IsSameAs("end") && word2.IsSameAs("procedure") && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                                        {
