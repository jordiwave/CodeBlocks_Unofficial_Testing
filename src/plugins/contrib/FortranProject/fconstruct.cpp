...
void FConstruct::GetWords(int i, wxString & word1, wxString & word2, wxString & word3, FCLid & flid) const
{
    ...
    if (word1.IsSameAs(_T("if")) && word2.IsSameAs(_T("then")) && word3.IsSameAs(wxEmptyString))
    {
        ...
        if (word1.IsSameAs(_T("else")) && word2.IsSameAs(_T("if")) && word3.IsSameAs(_T("then")))
        {
            flid = fclIf_else_if_then;
        }
        else
            if (word1.IsSameAs(_T("else")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
            {
                flid = fclIf_else;
            }
            else
                if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("if")) && word3.IsSameAs(wxEmptyString))
                {
                    flid = fclIf_end_if;
                }
                else
                    if (word1.IsSameAs(_T("do")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                    {
                        flid = fclDo_do;
                    }
                    else
                        if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("do")) && word3.IsSameAs(wxEmptyString))
                        {
                            flid = fclDo_end_do;
                        }
                        else
                            if (word1.IsSameAs(_T("interface")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                            {
                                flid = fclInterf_interf;
                            }
                            else
                                if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("interface")) && word3.IsSameAs(wxEmptyString))
                                {
                                    flid = fclInterf_end_interf;
                                }
                                else
                                    if (word1.IsSameAs(_T("function")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                    {
                                        flid = fclFun_fun;
                                    }
                                    else
                                        if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("function")) && word3.IsSameAs(wxEmptyString))
                                        {
                                            flid = fclFun_end_fun;
                                        }
                                        else
                                            if (word1.IsSameAs(_T("subroutine")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                            {
                                                flid = fclSub_sub;
                                            }
                                            else
                                                if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("subroutine")) && word3.IsSameAs(wxEmptyString))
                                                {
                                                    flid = fclSub_end_sub;
                                                }
                                                else
                                                    if (word1.IsSameAs(_T("program")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                    {
                                                        flid = fclProg_prog;
                                                    }
                                                    else
                                                        if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("program")) && word3.IsSameAs(wxEmptyString))
                                                        {
                                                            flid = fclProg_end_prog;
                                                        }
                                                        else
                                                            if (word1.IsSameAs(_T("module")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                            {
                                                                flid = fclMod_module;
                                                            }
                                                            else
                                                                if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("module")) && word3.IsSameAs(wxEmptyString))
                                                                {
                                                                    flid = fclMod_end_module;
                                                                }
                                                                else
                                                                    if (word1.IsSameAs(_T("submodule")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                    {
                                                                        flid = fclSubmod_submod;
                                                                    }
                                                                    else
                                                                        if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("submodule")) && word3.IsSameAs(wxEmptyString))
                                                                        {
                                                                            flid = fclSubmod_end_submod;
                                                                        }
                                                                        else
                                                                            if (word1.IsSameAs(_T("select")) && word2.IsSameAs(_T("case")) && word3.IsSameAs(wxEmptyString))
                                                                            {
                                                                                flid = fclSelectCase_start;
                                                                            }
                                                                            else
                                                                                if (word1.IsSameAs(_T("case")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                {
                                                                                    flid = fclSelectCase_case;
                                                                                }
                                                                                else
                                                                                    if (word1.IsSameAs(_T("case")) && word2.IsSameAs(_T("default")) && word3.IsSameAs(wxEmptyString))
                                                                                    {
                                                                                        flid = fclSelectCase_case;
                                                                                    }
                                                                                    else
                                                                                        if (word1.IsSameAs(_T("select")) && word2.IsSameAs(_T("type")) && word3.IsSameAs(wxEmptyString))
                                                                                        {
                                                                                            flid = fclSelectType_start;
                                                                                        }
                                                                                        else
                                                                                            if (word1.IsSameAs(_T("type")) && word2.IsSameAs(_T("is")) && word3.IsSameAs(wxEmptyString))
                                                                                            {
                                                                                                flid = fclSelectType_type_is;
                                                                                            }
                                                                                            else
                                                                                                if (word1.IsSameAs(_T("class")) && word2.IsSameAs(_T("is")) && word3.IsSameAs(wxEmptyString))
                                                                                                {
                                                                                                    flid = fclSelectType_class_is;
                                                                                                }
                                                                                                else
                                                                                                    if (word1.IsSameAs(_T("class")) && word2.IsSameAs(_T("default")) && word3.IsSameAs(wxEmptyString))
                                                                                                    {
                                                                                                        flid = fclSelectType_class_default;
                                                                                                    }
                                                                                                    else
                                                                                                        if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("select")) && word3.IsSameAs(wxEmptyString))
                                                                                                        {
                                                                                                            flid = fclSelect_end;
                                                                                                        }
                                                                                                        else
                                                                                                            if (word1.IsSameAs(_T("select")) && word2.IsSameAs(_T("rank")) && word3.IsSameAs(wxEmptyString))
                                                                                                            {
                                                                                                                flid = fclSelectRank_start;
                                                                                                            }
                                                                                                            else
                                                                                                                if (word1.IsSameAs(_T("rank")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                {
                                                                                                                    flid = fclSelectRank_rank;
                                                                                                                }
                                                                                                                else
                                                                                                                    if (word1.IsSameAs(_T("rank")) && word2.IsSameAs(_T("default")) && word3.IsSameAs(wxEmptyString))
                                                                                                                    {
                                                                                                                        flid = fclSelectRank_rank;
                                                                                                                    }
                                                                                                                    else
                                                                                                                        if (word1.IsSameAs(_T("type")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                        {
                                                                                                                            flid = fclType_type;
                                                                                                                        }
                                                                                                                        else
                                                                                                                            if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("type")) && word3.IsSameAs(wxEmptyString))
                                                                                                                            {
                                                                                                                                flid = fclType_end_type;
                                                                                                                            }
                                                                                                                            else
                                                                                                                                if (word1.IsSameAs(_T("enum")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                {
                                                                                                                                    flid = fclEnum_enum;
                                                                                                                                }
                                                                                                                                else
                                                                                                                                    if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("enum")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                    {
                                                                                                                                        flid = fclEnum_end_enum;
                                                                                                                                    }
                                                                                                                                    else
                                                                                                                                        if (word1.IsSameAs(_T("critical")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                        {
                                                                                                                                            flid = fclCritical_critical;
                                                                                                                                        }
                                                                                                                                        else
                                                                                                                                            if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("critical")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                            {
                                                                                                                                                flid = fclCritical_end_critical;
                                                                                                                                            }
                                                                                                                                            else
                                                                                                                                                if (word1.IsSameAs(_T("forall")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                {
                                                                                                                                                    flid = fclForall_forall;
                                                                                                                                                }
                                                                                                                                                else
                                                                                                                                                    if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("forall")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                    {
                                                                                                                                                        flid = fclForall_end_forall;
                                                                                                                                                    }
                                                                                                                                                    else
                                                                                                                                                        if (word1.IsSameAs(_T("associate")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                        {
                                                                                                                                                            flid = fclAssoc_associate;
                                                                                                                                                        }
                                                                                                                                                        else
                                                                                                                                                            if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("associate")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                            {
                                                                                                                                                                flid = fclAssoc_end_associate;
                                                                                                                                                            }
                                                                                                                                                            else
                                                                                                                                                                if (word1.IsSameAs(_T("block")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                {
                                                                                                                                                                    flid = fclBlock_block;
                                                                                                                                                                }
                                                                                                                                                                else
                                                                                                                                                                    if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("block")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                    {
                                                                                                                                                                        flid = fclBlock_end_block;
                                                                                                                                                                    }
                                                                                                                                                                    else
                                                                                                                                                                        if (word1.IsSameAs(_T("block")) && word2.IsSameAs(_T("data")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                        {
                                                                                                                                                                            flid = fclBlockdata_blockdata;
                                                                                                                                                                        }
                                                                                                                                                                        else
                                                                                                                                                                            if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("block")) && word3.IsSameAs(_T("data")))
                                                                                                                                                                            {
                                                                                                                                                                                flid = fclBlockdata_end_blockdata;
                                                                                                                                                                            }
                                                                                                                                                                            else
                                                                                                                                                                                if (word1.IsSameAs(_T("change")) && word2.IsSameAs(_T("team")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                {
                                                                                                                                                                                    flid = fclTeam_change_team;
                                                                                                                                                                                }
                                                                                                                                                                                else
                                                                                                                                                                                    if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("team")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                    {
                                                                                                                                                                                        flid = fclTeam_end_team;
                                                                                                                                                                                    }
                                                                                                                                                                                    else
                                                                                                                                                                                        if (word1.IsSameAs(_T("where")) && word2.IsSameAs(wxEmptyString) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                        {
                                                                                                                                                                                            flid = fclWhere_where;
                                                                                                                                                                                        }
                                                                                                                                                                                        else
                                                                                                                                                                                            if (word1.IsSameAs(_T("else")) && word2.IsSameAs(_T("where")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                            {
                                                                                                                                                                                                flid = fclWhere_else_where;
                                                                                                                                                                                            }
                                                                                                                                                                                            else
                                                                                                                                                                                                if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("where")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                                {
                                                                                                                                                                                                    flid = fclWhere_end_where;
                                                                                                                                                                                                }
                                                                                                                                                                                                else
                                                                                                                                                                                                    if (word1.IsSameAs(_T("module")) && word2.IsSameAs(_T("procedure")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                                    {
                                                                                                                                                                                                        flid = fclProc_mod_proc;
                                                                                                                                                                                                    }
                                                                                                                                                                                                    else
                                                                                                                                                                                                        if (word1.IsSameAs(_T("end")) && word2.IsSameAs(_T("procedure")) && word3.IsSameAs(wxEmptyString))
                                                                                                                                                                                                        {
...
void FConstruct::MakeFCLReMap()
{
    ...
    FCLReMap[fclDo_end_do] = new wxRegEx(_T("^[\\s\\t]*(end)(\\s*)(do)\\b"), options);
    FCLReMap[fclInterf_interf] = new wxRegEx(_T("^[\\s\\t]*(abstract[\\s\\t]+)?interface\\b"), options);
    FCLReMap[fclInterf_end_interf] = new wxRegEx(_T("^[\\s\\t]*(end)(\\s*)(interface)\\b"), options);
    ...
    FCLReMap[fclType_type] = new wxRegEx(_T("^([\\s\\t]*)(type)(\\s*)((\\s*,\\s*(([a-z0-9_]+)|(extends\\([a-z0-9_]+\\))))*\\s*::)?(\\s*)([a-z0-9_]+)\\b"), options);
    FCLReMap[fclType_end_type] = new wxRegEx(_T("^[\\s\\t]*(end)(\\s*)(type)\\b"), options);
    FCLReMap[fclEnum_enum] = new wxRegEx(_T("^[\\s\\t]*enum\\b"), options);
    FCLReMap[fclEnum_end_enum] = new wxRegEx(_T("^[\\s\\t]*(end)(\\s*)(enum)\\b"), options);
    FCLReMap[fclCritical_critical] = new wxRegEx(startLabel + _T("(critical)\\b"), options);
    FCLReMap[fclCritical_end_critical] = new wxRegEx(_T("^[\\s\\t]*(end)(\\s*)(critical)\\b"), options);
    FCLReMap[fclForall_forall] = new wxRegEx(startLabel + _T("(forall)(\\s*)(\\([^\\)]+\\))(\\s*)$"), options);
    FCLReMap[fclForall_end_forall] = new wxRegEx(_T("^[\\s\\t]*(end)(\\s*)(forall)\\b"), options);
    FCLReMap[fclAssoc_associate] = new wxRegEx(startLabel + _T("(associate)(\\s*)(\\(.*\\))(\\s*)$"), options);
    FCLReMap[fclAssoc_end_associate] = new wxRegEx(_T("^[\\s\\t]*(end)(\\s*)(associate)\\b"), options);
    ...
    FCLReMap[fclTeam_end_team] = new wxRegEx(_T("^([\\s\\t]*)([0-9]*)([\\s\\t]*)(end\\s*team)\\b"), options);
    ...
    FCLReMap[fclWhere_else_where] = new wxRegEx(_T("^([\\s\\t]*)(else\\s*where)\\b"), options);
    FCLReMap[fclWhere_end_where] = new wxRegEx(_T("^[\\s\\t]*(end)(\\s*)(where)\\b"), options);
