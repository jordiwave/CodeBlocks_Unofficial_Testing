...
public:
    ...
    void AddPartFirst(wxString& str)
    {
        m_PartFirst = str;
    };
    void AddPartLast(wxString& str)
    {
        m_PartLast = str;
    };
    void AddResultVariable(wxString& str)
    {
        m_ResultVariable = str;
    };
