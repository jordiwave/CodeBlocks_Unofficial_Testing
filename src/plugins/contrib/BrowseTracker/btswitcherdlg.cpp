...
// ----------------------------------------------------------------------------
{
    ...
    if ( wxGetKeyState(WXK_ALT ))    SetModifierKey(WXK_ALT);
    if ( wxGetKeyState(WXK_CONTROL)) SetModifierKey(WXK_CONTROL);
    if ( wxGetKeyState(WXK_SHIFT))   SetModifierKey(WXK_SHIFT);
}
