...
*/
// RCS-ID: $Id: BrowseMarks.cpp 12539 2021-11-27 22:53:18Z pecanh $
...
// ----------------------------------------------------------------------------
{
    ...
    if (not control)
    {
        return;    //2021/11/27 avoid possible crash
    }
...
// ----------------------------------------------------------------------------
{
    ...
    if (eb)
    {
        cbed = Manager::Get()->GetEditorManager()->GetBuiltinEditor(eb);
    }
