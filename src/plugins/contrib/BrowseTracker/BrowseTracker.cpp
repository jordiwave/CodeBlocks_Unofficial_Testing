...
int     GetBrowseMarkerId()
{
    return gBrowse_MarkerId;
}
int     GetBrowseMarkerStyle()
{
    return gBrowse_MarkerStyle;
}
...
// ----------------------------------------------------------------------------
{
    ...
    if (m_BrowseMarksEnabled)
    {
        m_UserMarksStyle = BookMarksStyle;
    }
        ...
        do
        {
            if (m_EbBrowse_MarksHash.find(eb) != m_EbBrowse_MarksHash.end())
            {
                ...
                else
                {
                    ...
                    if (m_nBrowseMarkPreviousSentry++)
                    {
                        break;
                    }
...
// ----------------------------------------------------------------------------
{
    ...
    for (int i = 0; i < MaxEntries ; ++i)
    {
        ...
        if (eb)
        {
            pBrowse_Marks = GetBrowse_MarksFromHash(eb);
        }

        if (eb && pBrowse_Marks)
        {
            pBrowse_Marks->SetBrowseMarksStyle(userStyle);
        }
    }//for
}
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
{
    ...
    if (eb && pBrowse_Marks)
    {
        pBrowse_Marks->ImportBrowse_Marks();
    }
}
// ----------------------------------------------------------------------------
    ...
    if ((event.GetEventType() ==  wxEVT_LEFT_UP)
        ...
        do
        {
            ...
            if (event.GetEventType() == wxEVT_LEFT_DOWN)
            {
                ...
                m_MouseXPosn = event.GetX();
                m_MouseYPosn = event.GetY();
            ...
            if (event.GetEventType() == wxEVT_LEFT_UP)
            {
                ...
                if (useOnlyLeftMouse)
                {
                    ...
                    if (ctrlKeyIsDown)
                    {
                        break;    //This is useOnlyLeftMouse w/o ctrl
                    }

                    if (m_IsMouseDoubleClick)
                    {
                        break;
                    }
    ...
    if (cbed)
        do
        {
            if (m_EbBrowse_MarksHash.find(eb) != m_EbBrowse_MarksHash.end())
            {
                ...
                if (not LineHasBrowseMarker(control, m_CurrScrLine))
                {
                    asm("int3"); /*trap*/
                }
            ...
            if (GetEditorBrowsedCount())
                for (int i = 0; i < MaxEntries - 1; ++i)
                {
                    if (m_apEditors[i] == 0)
                    {
                        ...
                        if (m_CurrEditorIndex == (i + 1))
                        {
                            --m_CurrEditorIndex;
                        }

                        if (m_LastEditorIndex == (i + 1))
                        {
                            --m_LastEditorIndex;
                        }
                    }
                        ...
                        if (pBrowse_MarksArc)
                            switch (1)
                            {
                                default:
                                    ...
                                    if (not m_EbBrowse_MarksHash[eb])
                                    {
                                        break;    //avoid a possible crash here
                                    }
...
// ----------------------------------------------------------------------------
{
    ...
    if (IsAttached() && m_InitDone)
    {
        ...
        if (pcbProject)
        {
            ...
            if (pProjectData)
            {
                pProjectData->AddEditor(eb->GetFilename());
            }
        }
...
// ----------------------------------------------------------------------------
{
    ...
    if (++m_LastEditorIndex >= MaxEntries)
    {
        m_LastEditorIndex = 0;
    }
...
// ----------------------------------------------------------------------------
{
    ...
    if (not pCBProject)
    {
        return;    //caused by importing a project
    }
