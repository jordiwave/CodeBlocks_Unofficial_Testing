            ...
            for (size_t i = 0; i < PathArray.Count(); i++)
            {
                ...
                while ((path_index >= 0) && (pattern_index >= 0))
                {
                    ...
                    if (IsVariable(PatternPart))
                    {
                        ...
                        {
                            if (Vars[VarName] != Path[path_index])
                            {
                                break;
                            }
                        }
                    ...
                    {
                        if (PatternPart != Path[path_index])
                        {
                            break;
                        }
                    }
