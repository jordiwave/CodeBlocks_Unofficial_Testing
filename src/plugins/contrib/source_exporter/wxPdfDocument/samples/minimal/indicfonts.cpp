...
static int writeFullMoon(wxPdfDocument & pdf, const wxString & txt1, const wxString & txt2, const wxString & fontName)
{
    int rc = 0;
...
static int fullmoon(bool testMode)
{
    int rc = 0;
...
static int writesample(wxPdfDocument & pdf, const wxString & header, const wxString & sampleFile, const wxString & fontName)
{
    int rc = 0;
...
static int samples(bool testMode)
{
    int rc = 0;
