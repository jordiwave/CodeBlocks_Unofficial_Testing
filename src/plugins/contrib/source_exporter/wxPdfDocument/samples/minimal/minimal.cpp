...
void PdfDocTutorial::ShowGroup(int group)
{
    ...
    do
    {
        ...
        switch (group)
        {
            case 1:
                ...
                {
                    case '1':
                        cout << endl << "Running 'tutorial 1' ..." << endl;
                        tutorial1();
                        break;

                    case '2':
                        cout << endl << "Running 'tutorial 2' ..." << endl;
                        tutorial2();
                        break;

                    case '3':
                        cout << endl << "Running 'tutorial 3' ..." << endl;
                        tutorial3();
                        break;

                    case '4':
                        cout << endl << "Running 'tutorial 4' ..." << endl;
                        tutorial4();
                        break;

                    case '5':
                        cout << endl << "Running 'tutorial 5' ..." << endl;
                        tutorial5();
                        break;

                    case '6':
                        cout << endl << "Running 'tutorial 6' ..." << endl;
                        tutorial6();
                        break;

                    case '7':
                        cout << endl << "Running 'tutorial 7' ..." << endl;
                        tutorial7();
                        break;

                    case '8':
                        cout << endl << "Running 'bookmark' ..." << endl;
                        bookmark();
                        break;
#if wxUSE_UNICODE

                    case '9':
                        cout << endl << "Running 'cjktest' ..." << endl;
                        cjktest();
                        break;
#else

                    case '9':
                        cout << endl << "'cjktest' is available in Unicode build only!" << endl;
                        break;
#endif
            ...
            case 2:
                ...
                {
                    case '1':
                        cout << endl << "Running 'protection1' ..." << endl;
                        protection1();
                        break;

                    case '2':
                        cout << endl << "Running 'protection2' ..." << endl;
                        protection2();
                        break;

                    case '3':
                        cout << endl << "Running 'clipping' ..." << endl;
                        clipping();
                        break;

                    case '4':
                        cout << endl << "Running 'drawing' ..." << endl;
                        drawing();
                        break;

                    case '5':
                        cout << endl << "Running 'rotation' ..." << endl;
                        rotation();
                        break;

                    case '6':
                        cout << endl << "Running 'wmf' ..." << endl;
                        wmf();
                        break;

                    case '7':
                        cout << endl << "Running 'transformation' ..." << endl;
                        transformation();
                        break;

                    case '8':
                        cout << endl << "Running 'gradients' ..." << endl;
                        gradients();
                        break;

                    case '9':
                        cout << endl << "Running 'charting' ..." << endl;
                        charting();
                        break;
            ...
            case 3:
                ...
                {
                    case '1':
                        cout << endl << "Running 'labels' ..." << endl;
                        labels();
                        break;

                    case '2':
                        cout << endl << "Running 'barcodes' ..." << endl;
                        barcodes();
                        break;

                    case '3':
                        cout << endl << "Running 'javascript' ..." << endl;
                        javascript();
                        break;

                    case '4':
                        cout << endl << "Running 'form' ..." << endl;
                        form();
                        break;

                    case '5':
                        cout << endl << "Running 'markup' ..." << endl;
                        xmlwrite();
                        break;

                    case '6':
                        cout << endl << "Running 'transparency' ..." << endl;
                        transparency();
                        break;

                    case '7':
                        cout << endl << "Running 'templates1' ..." << endl;
                        templates1();
                        break;

                    case '8':
                        cout << endl << "Running 'templates2' ..." << endl;
                        templates2();
                        break;

                    case '9':
                        cout << endl << "Running 'layers' ..." << endl;
                        layers();
                        break;
            ...
            case 4:
                ...
                {
                    case '1':
                        cout << endl << "Running 'kerning' ..." << endl;
                        kerning();
                        break;
#if defined(__WXMSW__)
#if wxUSE_UNICODE
                    ...
                    case '2':
                        cout << endl << "Running 'glyphwriting' ..." << endl;
                        glyphwriting();
                        break;
#else

                    case '2':
                        cout << endl << "'glyphwriting' is available in Unicode build only!" << endl;
                        break;
#endif
#else

                    case '2':
                        cout << endl << "'glyphwriting' is currently available in wxMSW build only!" << endl;
                        break;
#endif
#if wxUSE_UNICODE

                    case '3':
                        cout << endl << "Running 'indicfonts' ..." << endl;
                        indicfonts();
                        break;
#else

                    case '3':
                        cout << endl << "'indicfonts' is available in Unicode build only!" << endl;
                        break;
#endif

                    case '4':
                        cout << endl << "Running 'attachment' ..." << endl;
                        attachment();
                        break;
#if 0

                    case 'z':
                        cout << endl << "Running 'w' ..." << endl;
                        w();
                        break;
#endif
