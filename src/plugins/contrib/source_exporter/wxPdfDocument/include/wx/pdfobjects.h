...
public:
    ...
    {
        m_isHexString = isHexString;
    }

    /// Check whether string is hexadecimal
    bool IsHexString() const
    {
        return m_isHexString;
    }
...
public:
    ...
    {
        return m_originalObjectId;
    }

    /// Get actual object id
    int GetActualObjectId() const
    {
        return m_actualObjectId;
    }
