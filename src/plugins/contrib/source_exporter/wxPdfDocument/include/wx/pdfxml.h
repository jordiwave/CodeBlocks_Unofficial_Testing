...
class WXDLLIMPEXP_PDFDOC wxPdfCellContext
{
    public:
        ...
        {
            return (unsigned int) m_linewidth.GetCount();
        }
        ...
        {
            return (unsigned int) m_contexts.GetCount();
        }
...
class WXDLLIMPEXP_PDFDOC wxPdfTable
{
    public:
        ...
        {
            const double height = m_rowHeights[row];
            return height;
        };
        ...
        {
            return m_headHeight + m_bodyHeight;
        }
