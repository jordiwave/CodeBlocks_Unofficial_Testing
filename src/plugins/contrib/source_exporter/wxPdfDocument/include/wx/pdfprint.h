...
class WXDLLIMPEXP_PDFDOC wxPdfPrintData : public wxObject
{
    public:
        ...
        {
            return m_printDialogFlags;
        }
        void SetPrintDialogFlags(int flags)
        {
            m_printDialogFlags = flags;
        }
...
class WXDLLIMPEXP_PDFDOC wxPdfPreviewDCImpl : public wxDCImpl
{
    public:
        ...
        {
            return m_pdfdc->GetResolution();
        }

        virtual bool CanGetTextExtent() const
        {
            return m_pdfdc->CanGetTextExtent();
        }

        virtual wxCoord GetCharHeight() const
        {
            return m_pdfdc->GetCharHeight();
        }
        virtual wxCoord GetCharWidth() const
        {
            return m_pdfdc->GetCharWidth();
        }
    ...
    public:
        ...
        {
            return m_dc.GetLogicalFunction();
        }
        ...
        {
            return m_dc.GetMapMode();
        }

        virtual void SetUserScale(double x, double y)
        {
            m_dc.SetUserScale(x, y);
        }
        ...
        {
            m_dc.DoGetLogicalOrigin(x, y);
        }

        virtual void SetDeviceOrigin(wxCoord x, wxCoord y)
        {
            m_dc.SetDeviceOrigin(x, y);
        }
        virtual void DoGetDeviceOrigin(wxCoord * x, wxCoord * y) const
        {
            m_dc.DoGetDeviceOrigin(x, y);
        }

        virtual void SetDeviceLocalOrigin(wxCoord x, wxCoord y)
        {
            m_dc.SetDeviceLocalOrigin(x, y);
        }
        virtual void ComputeScaleAndOrigin()
        {
            m_dc.ComputeScaleAndOrigin();
        }
        virtual void SetAxisOrientation(bool x, bool y)
        {
            m_dc.SetAxisOrientation(x, y);
        }
