...
void wxPdfFontParser::SeekI(int offset, wxInputStream * stream)
{
    stream->SeekI(offset);
}
...
void wxPdfFontParser::SkipBytes(int count, wxInputStream * stream)
{
    if (stream != NULL)
    {
...
wxString wxPdfFontParser::ReadString(int length, wxInputStream * stream)
{
...
wxString wxPdfFontParser::ReadString(wxInputStream & fileStream)
{
