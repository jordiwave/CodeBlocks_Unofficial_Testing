...
wxString wxPdfUtility::GetUniqueId(const wxString & prefix)
{
...
wxString wxPdfUtility::Double2String(double value, int precision)
{
    wxString number;
...
double wxPdfUtility::String2Double(const wxString & str, const wxString & defaultUnit, double scaleFactor)
{
...
double wxPdfUtility::ForceRange(double value, double minValue, double maxValue)
{
    if (value < minValue)
    {
        value = minValue;
