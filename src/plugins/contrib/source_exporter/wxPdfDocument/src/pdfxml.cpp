...
static wxString GetXmlAttribute(const wxXmlNode * node, const wxString & attrName, const wxString & defaultVal)
{
    return node->GetAttribute(attrName, defaultVal);
}

static bool IsLastContentNode(wxXmlNode * node, const wxXmlNode * root, bool applyFinalVerticalSpace = true)
{
...
wxArrayDouble wxPdfDocument::ApplyViewport(const wxString & viewport, double width, double height)
{
...
void wxPdfCellContext::AddLastLineValues(double width, int spaces)
{
...
void wxPdfTable::InsertCell(wxPdfTableCell * cell)
{
...
void wxPdfTable::WriteRow(unsigned int row, double x, double y)
{
        ...
        if (foundCell != m_table.end())
        {
            ...
            if (border != wxPDF_BORDER_NONE)
            {
                ...
                else
                {
                    ...
                    {
                        m_document->Line(x,   y,   x,   y + h);
                    }

                    if (border & wxPDF_BORDER_TOP)
                    {
                        m_document->Line(x,   y,   x + w, y);
                    }

                    if (border & wxPDF_BORDER_BOTTOM)
                    {
                        m_document->Line(x,   y + h, x + w, y + h);
                    }

                    if (border & wxPDF_BORDER_RIGHT)
                    {
                        m_document->Line(x + w, y,   x + w, y + h);
                    }
                }
...
void wxPdfTable::SetColumnWidth(int col, double width)
{
...
void wxPdfDocument::PrepareXmlTable(wxXmlNode * node, wxPdfCellContext & context)
{
    ...
    while (child)
    {
        ...
        if (name == wxS("colgroup"))
        {
            ...
            if (name == wxS("thead") || name == wxS("tbody"))
            {
                ...
                while (rowChild)
                {
                    if ((rowChild->GetName()).Lower() == wxS("tr"))
                    {
                        ...
                        if (rowColour.Length() == 0)
                        {
                            ...
                            {
                                // even row numbers
                                if (evenColour.Length() > 0)
                                {
                                    rowColour = evenColour;
                                }
                            }
                            else
                            {
                                // odd row numbers
                                if (oddColour.Length() > 0)
                                {
                                    rowColour = oddColour;
                                }
                            }
                        ...
                        if (maxHeight.Length() > 0)
                        {
                            ...
                            if (rowMaxHeight > 0 && rowMaxHeight < rowMinHeight)
                            {
                        ...
                        while (colChild)
                        {
                            if ((colChild->GetName()).Lower() == wxS("td"))
                            {
                                ...
                                {
                                    if (strBorder.Contains(wxS("L")))
                                    {
                                        border |= wxPDF_BORDER_LEFT;
                                    }

                                    if (strBorder.Contains(wxS("T")))
                                    {
                                        border |= wxPDF_BORDER_TOP;
                                    }

                                    if (strBorder.Contains(wxS("B")))
                                    {
                                        border |= wxPDF_BORDER_BOTTOM;
                                    }

                                    if (strBorder.Contains(wxS("R")))
                                    {
                                        border |= wxPDF_BORDER_RIGHT;
                                    }
                                }
                                else
                                    if (table->HasBorder())
                                ...
                                if (align == wxS("right"))
                                {
                                    hAlignment = wxPDF_ALIGN_RIGHT;
                                }
                                else
                                    if (align == wxS("center"))
                                    {
                                        hAlignment = wxPDF_ALIGN_CENTER;
                                    }
                                ...
                                if (align == wxS("bottom"))
                                {
                                    vAlignment = wxPDF_ALIGN_BOTTOM;
                                }
                                else
                                    if (align == wxS("middle"))
                                    {
                                        vAlignment = wxPDF_ALIGN_MIDDLE;
                                    }
                                    else
                                        if (align == wxS("center"))
                                        {
...
void wxPdfDocument::PrepareXmlCell(wxXmlNode * node, wxPdfCellContext & context)
{
                            ...
                            if (name == wxS("ol"))
                            {
                                ...
                                if (name == wxS("br"))
                                {
                                    ...
                                    if (name == wxS("p"))
                                    {
                                        ...
                                        if (align == wxS("right"))
                                        {
                                            alignment = wxPDF_ALIGN_RIGHT;
                                        }
                                        else
                                            if (align == wxS("center"))
                                            {
                                                alignment = wxPDF_ALIGN_CENTER;
                                            }
                                            else
                                                if (align == wxS("justify"))
                                                {
                                                    alignment = wxPDF_ALIGN_JUSTIFY;
                                                }
                                                    ...
                                                    if (name == wxS("span"))
                                                    {
                                                        ...
                                                        if (name == wxS("font"))
                                                        {
                                                            ...
                                                            if (name == wxS("code"))
                                                            {
                                                                ...
                                                                if (name == wxS("h1") || name == wxS("h2") || name == wxS("h3") ||
                                                                        ...
                                                                        if (name == wxS("table"))
                                                                        {
                                                                            ...
                                                                            if (align == wxS("right"))
                                                                            {
                                                                                ...
                                                                                if (align == wxS("center"))
                                                                                {
                                                                                    ...
                                                                                    if (align == wxS("justify"))
                                                                                    {
                                                                                        hAlignment = wxPDF_ALIGN_JUSTIFY;
                                                                                    }
...
void wxPdfDocument::WriteXml(const wxString & xmlString)
{
    if (GetLineHeight() == 0)
    {
...
void wxPdfDocument::WriteXmlCell(wxXmlNode * node, wxPdfCellContext & context)
{
    wxPdfCellContext * newContext;
    wxXmlNode * child = node->GetChildren();
