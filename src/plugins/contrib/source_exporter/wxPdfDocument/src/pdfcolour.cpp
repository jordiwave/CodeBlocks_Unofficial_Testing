...
wxColourDatabase * wxPdfColour::GetColourDatabase()
{
...
void wxPdfColour::SetColour(const unsigned char grayscale)
{
...
void wxPdfColour::SetColour(const unsigned char red, const unsigned char green, const unsigned char blue)
{
    SetColour(wxColour(red, green, blue));
}

void wxPdfColour::SetColour(double cyan, double magenta, double yellow, double black)
{
...
void wxPdfColour::SetColour(const wxPdfSpotColour & spot, double tint)
{
