...
wxString wxPdfFontDataCore::GetWidthsAsString(bool subset, wxPdfSortedArrayInt * usedGlyphs, wxPdfChar2GlyphMap * subsetGlyphs) const
{
    wxUnusedVar(subset);
...
#if wxUSE_UNICODE
wxMBConv * wxPdfFontDataCore::GetEncodingConv() const
{
...
double wxPdfFontDataCore::GetStringWidth(const wxString & s, const wxPdfEncoding * encoding, bool withKerning, double charSpacing) const
{
...
bool wxPdfFontDataCore::CanShow(const wxString & s, const wxPdfEncoding * encoding) const
{
    bool canShow = true;
...
wxString wxPdfFontDataCore::ConvertCID2GID(const wxString & s,
