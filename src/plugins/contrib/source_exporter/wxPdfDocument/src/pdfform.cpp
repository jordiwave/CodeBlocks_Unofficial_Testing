...
void wxPdfAnnotationObject::SetRectangle(double x, double y, double width, double height)
{
    m_x = x;
    m_y = y;
    m_w = width;
...
void wxPdfDocument::OutIndirectObject(wxPdfIndirectObject * object)
{
    ...
    if (m_offsets->count(objectId - 1) == 0)
    {
        ...
        switch (object->GetType())
        {
            ...
            {
                radio = static_cast<wxPdfRadioButton *>
                        (kids[j]);
...
void wxPdfDocument::CheckBox(const wxString & name, double width, bool checked)
{
    CheckBox(name, m_x, m_y, width, checked);
}

void wxPdfDocument::CheckBox(const wxString & name, double x, double y, double width, bool checked)
{
...
void wxPdfDocument::ComboBox(const wxString & name, double width, double height, const wxArrayString & values)
{
...
void wxPdfDocument::PushButton(const wxString & name, double width, double height,
...
void wxPdfDocument::RadioButton(const wxString & group, const wxString & name, double width)
{
    RadioButton(group, name, m_x, m_y, width);
}

void wxPdfDocument::RadioButton(const wxString & group, const wxString & name,
...
void wxPdfDocument::TextField(const wxString & name, double width, double height,
...
void wxPdfDocument::AddFormField(wxPdfAnnotationWidget * field, bool setFormField)
{
...
void wxPdfDocument::SetFormColours(const wxPdfColour & borderColour,
...
void wxPdfDocument::SetFormBorderStyle(wxPdfBorderStyle borderStyle, double borderWidth)
{
    switch (borderStyle)
    {
        case wxPDF_BORDER_DASHED:
            m_formBorderStyle = wxString(wxS("D"));
            break;

        case wxPDF_BORDER_BEVELED:
            m_formBorderStyle = wxString(wxS("B"));
            break;

        case wxPDF_BORDER_INSET:
            m_formBorderStyle = wxString(wxS("I"));
            break;

        case wxPDF_BORDER_UNDERLINE:
            m_formBorderStyle = wxString(wxS("U"));
            break;

        case wxPDF_BORDER_SOLID:
        default:
            m_formBorderStyle = wxString(wxS("S"));
            break;
    }
