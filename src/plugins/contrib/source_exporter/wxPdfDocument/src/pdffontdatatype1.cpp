...
#if wxUSE_UNICODE
void wxPdfFontDataType1::CreateDefaultEncodingConv()
{
...
bool wxPdfFontDataType1::LoadFontMetrics(wxXmlNode * root)
{
    bool bName  = false,
         bDesc  = false,
         bFile  = true,
...
bool wxPdfFontDataType1::Initialize()
{
    bool ok = true;
...
double wxPdfFontDataType1::GetStringWidth(const wxString & s, const wxPdfEncoding * encoding, bool withKerning, double charSpacing) const
{
...
bool wxPdfFontDataType1::CanShow(const wxString & s, const wxPdfEncoding * encoding) const
{
    bool canShow = true;
    const wxPdfChar2GlyphMap * convMap = FindEncodingMap(encoding);
...
wxString wxPdfFontDataType1::ConvertCID2GID(const wxString & s,
...
wxString wxPdfFontDataType1::GetWidthsAsString(bool subset, wxPdfSortedArrayInt * usedGlyphs, wxPdfChar2GlyphMap * subsetGlyphs) const
{
    wxUnusedVar(subset);
    wxUnusedVar(usedGlyphs);
    wxUnusedVar(subsetGlyphs);
...
#if wxUSE_UNICODE
wxString wxPdfFontDataType1::GetWidthsAsString(const wxArrayString & glyphNames, bool subset, wxPdfSortedArrayInt * usedGlyphs, wxPdfChar2GlyphMap * subsetGlyphs) const
{
    wxUnusedVar(subset);
    wxUnusedVar(usedGlyphs);
    wxUnusedVar(subsetGlyphs);
...
bool wxPdfFontDataType1::GetGlyphNames(wxArrayString & glyphNames) const
{
...
bool wxPdfFontDataType1::CompressFontData(wxOutputStream * fontData, wxInputStream * pfbFile)
{
    bool ok = true;
...
size_t wxPdfFontDataType1::WriteFontData(wxOutputStream * fontData, wxPdfSortedArrayInt * usedGlyphs, wxPdfChar2GlyphMap * subsetGlyphs)
{
    wxUnusedVar(usedGlyphs);
    wxUnusedVar(subsetGlyphs);
...
size_t wxPdfFontDataType1::WriteUnicodeMap(wxOutputStream * mapData,
                                           const wxPdfEncoding * encoding,
                                           wxPdfSortedArrayInt * usedGlyphs,
