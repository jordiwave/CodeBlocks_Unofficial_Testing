...
public:
    ...
    {
        return _("ftp.gnu.org");
    }

    // Return the FTP server path were to find the dictionaries
    virtual wxString GetServerDirectory()
    {
        return _("/gnu/aspell/dict");
    }
    ...
    inline bool UseWin32Dictionaries()
    {
        return (wxINT32_SWAP_ALWAYS(128) == wxINT32_SWAP_ON_LE(128));
    }
