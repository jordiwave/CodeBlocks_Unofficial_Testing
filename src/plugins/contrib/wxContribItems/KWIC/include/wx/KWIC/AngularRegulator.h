...
class WXEXPORT kwxAngularRegulator : public wxControl
{
    public:
        kwxAngularRegulator(void)
        {
            m_id = -1 ;
        };
        ...
        void	SetExtCircleColour(wxColour colour)
        {
            m_cExtCircle = colour ;
        } ;
        void	SetIntCircleColour(wxColour colour)
        {
            m_cIntCircle = colour ;
        } ;

        void	SetKnobBorderColour(wxColour colour)
        {
            m_cKnobBorderColour = colour ;
        } ;
        void	SetKnobColour(wxColour colour)
        {
            m_cKnobColour = colour ;
        } ;

        void	SetLimitsColour(wxColour colour)
        {
            m_cLimitsColour = colour ;
        } ;
