...
class WXEXPORT kwxLCDDisplay : public wxWindow
{
protected:
    int mSegmentLen;
    int mSegmentWidth;
...
public:
    kwxLCDDisplay( wxWindow *parent, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize);
    kwxLCDDisplay() {};
    virtual ~kwxLCDDisplay();

    bool Create(wxWindow *parent, const wxPoint& pos, const wxSize& size );
