/**************************************************************************//**
 * \file			xh_kwxlcddisplayhandler.h
 * \author	Gary Harris
 * \date		19/4/2010.
 *
 ...
 *
 *****************************************************************************/
#ifndef XH_KWXLCDDISPLAYHANDLER_H_INCLUDED
...
public:
    ...
    DECLARE_DYNAMIC_CLASS(kwxLCDDisplayHandler)
};


#endif // XH_KWXLCDDISPLAYHANDLER_H_INCLUDED
