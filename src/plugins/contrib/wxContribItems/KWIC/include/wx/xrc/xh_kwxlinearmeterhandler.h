/**************************************************************************//**
 * \file		xh_kwxlinearmeterhandler.h
 * \author	Gary Harris
 * \date		25/4/2010.
 *
 ...
 *
 *****************************************************************************/
#ifndef XH_KWXLINEAMETERHANDLER_H_INCLUDED
...
class WXEXPORT kwxLinearMeterHandler : public wxXmlResourceHandler
{
    public:
        ...
        DECLARE_DYNAMIC_CLASS(kwxLinearMeterHandler)
};


#endif // XH_KWXLINEAMETERHANDLER_H_INCLUDED
