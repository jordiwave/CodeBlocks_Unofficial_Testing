/**************************************************************************//**
 * \file		xh_kwxlinearregulatorhandler.cpp
 * \author	Gary Harris
 * \date		24/4/2010.
 *
 ...
 *
 *****************************************************************************/
#include "wx/xrc/xh_kwxlinearregulatorhandler.h"
#include "wx/KWIC/LinearRegulator.h"

// Register with wxWidgets' dynamic class subsystem.
IMPLEMENT_DYNAMIC_CLASS(kwxLinearRegulatorHandler, wxXmlResourceHandler)

kwxLinearRegulatorHandler::kwxLinearRegulatorHandler()
{
