                         ...
                         wxBlockInt & left, wxBlockInt & right) const
{
    ...
    if (iBlock == *this)
    {
        return true;    // can combine all of this, no leftover
    }
                        ...
                        wxBlockInt & left, wxBlockInt & right) const
{
    ...
    if (iBlock == *this)
    {
        return true;    // can delete all of this, no leftover
    }
        ...
        for (int k = 0; k < int(extra.GetCount()); k++)
        {
            ...
            if (m_blocks[n].Intersects(extra[k]))
            {
                if (m_blocks[n].Contains(extra[k]))
                {
                    ...
                    if (extra[k].Contains(m_blocks[n]))
                    {
                        m_blocks.RemoveAt(n);
                        n = -1;
                        break;
                        ...
                        if (m_blocks[n].IsLarger(extra[k]) > 0)
                        {
