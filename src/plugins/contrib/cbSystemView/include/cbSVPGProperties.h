...
public:
    ...
    */
    ...
    bool CanRepresent(ValueRepresentation rep) const
    {
        return m_repCap.test(rep);
    };
    ValueRepresentation GetRepresentation() const
    {
        return m_rep;
    };
    void SetRepresentation(ValueRepresentation rep)
    {
        m_rep = rep;
        GetGrid()->Update();
    };
    ...
    {
        return m_mask;
    };             /**< Get bit mask for data */
    void SetMask(uint64_t msk)
    {
        m_mask = msk;
    };           /**< Get bit mask for data */

    uint64_t GetResetVal()  const
    {
        return m_resetValue;
    };       /**< Get reset value for data */
    void SetResetVal(uint64_t val)
    {
        m_resetValue = val;
    };       /**< Get reset value for data */
    ...
    {
        return m_resetMask;
    };        /**< Get bit mask for reset value */
    void SetResetMask(uint64_t msk)
    {
        m_resetMask = msk;
    };        /**< Get bit mask for reset value */
    ...
    {
        return m_bitSize;
    };          /**< Get bit size of the data*/
    void SetBitSize(uint64_t size)
    {
        m_bitSize = size;
    };
    ...
    {
        return m_bitOffset;
    };        /**< Get bit offset (<< operation) */
    void SetBitOffset(uint64_t of)
    {
        m_bitOffset = of;
    };        /**< Get bit offset (<< operation) */
