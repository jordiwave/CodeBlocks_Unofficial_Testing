...
inline bool wxFound(int result)
{
...
// ----------------------------------------------------------------------------
{
    ...
    for (size_t lineNo = 0; lineNo < lineKnt; ++lineNo)
    {
        ...
        if (not kbLineTxt.StartsWith(_T("bind")))
        {
            continue;
        }
