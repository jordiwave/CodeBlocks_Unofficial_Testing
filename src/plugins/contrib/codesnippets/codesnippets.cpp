...
*/
// $Id: codesnippets.cpp 12282 2021-01-01 06:41:09Z mortenmacfly $
...
// ----------------------------------------------------------------------------
{
    ...
    {
        m_CfgFilenameStr << m_Personality + _T(".") ;
    }
...
// ----------------------------------------------------------------------------
{
    ...
    if (obj == ((wxDataObjectSimple *)m_file))
    {
        ...
        if (obj == ((wxDataObjectSimple *)m_text))
        {
...
// ----------------------------------------------------------------------------
{
    ...
    do
    {
        if (argv0Str.Contains(_T(".exe")))
        {
            break;
        }

        if (argv0Str.Contains(_T(".bat")))
        {
            break;
        }

        if (argv0Str.Contains(_T(".cmd")))
        {
            break;
        }
