...
public:
    ...
    ThreadSearchView* GetThreadSearchView()
    {
        return m_pThreadSearchView;   //(pecan 2008/4/11)
    }
...
private:
    ...
    /** Adds project file paths to the strings array avoiding duplicated paths.
      ...
      */
    void AddSnippetFiles(wxSortedArrayString& sortedArrayString, cbProject& project);
