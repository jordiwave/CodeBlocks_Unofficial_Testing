...
// ----------------------------------------------------------------------------
{
    public:
        ...
        {
            return m_fileChanged = truefalse;
        }
        bool        GetFileChanged()
        {
        ...
        wxDateTime  GetSavedFileModificationTime()
        {
            return m_LastXmlModifiedTime;
        }
        ...
        bool IsUrlSnippet(wxTreeItemId treeItemId = (void *)0)
        {
            ...
            if (not fileName.StartsWith(wxT("http://")))
            {
                return false;
            }
