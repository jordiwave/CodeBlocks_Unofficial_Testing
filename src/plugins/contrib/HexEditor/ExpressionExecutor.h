...
*
* $Revision: 7109 $
* $Id: ExpressionExecutor.h 7109 2011-04-15 11:53:16Z mortenmacfly $
* $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/contrib/HexEditor/ExpressionExecutor.h $
*/
...
class Executor
{
    ...
    private:
        ...
        {
            if ((unsigned) pos >= m_Stack.size())
            {
                throw errorStackIndex;
            }
