...
*
* $Revision: 11221 $
* $Id: HexEditPanel.h 11221 2017-10-31 07:56:15Z fuscated $
* $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/contrib/HexEditor/HexEditPanel.h $
*/
...
class HexEditPanel: public EditorBase
{
    ...
    private:
        ...
        inline void ViewNotifyContentChange()
        {
            m_ViewNotifyContentChange = true;
        }

        /** \brief Notification about offset change from the view */
        inline void ViewNotifyOffsetChange(OffsetT newOffset)
        {
            m_Current = newOffset;
