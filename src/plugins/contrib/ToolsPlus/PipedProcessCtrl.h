...
public:
    ...
    bool ParsesLinks(wxString &LinkRegex)
    {
        LinkRegex=m_linkregex;
        return m_parselinks;
    }
    void ParseLinks(bool parselinks=true, wxString LinkRegex=LinkRegexDefault)
    {
