...
#ifndef PROJECTEXPORTER_H_INCLUDED
#define PROJECTEXPORTER_H_INCLUDED
...
class ProjectExporter : public cbPlugin
{
    ...
    private:
        ...
        /** @brief Check whether a project is open.
          *
          * @return bool @c true if a project is open, @c false otherwise.
          */
...
#endif // PROJECTEXPORTER_H_INCLUDED
