...
* $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/contrib/wxSmith/wxsresourcetree.h $
*/
...
class wxsResourceTree: public wxTreeCtrl
{
    public:
        ...
        static inline wxsResourceTree * Get()
        {
            return m_Singleton;
        }
...
inline wxsResourceTree * wxsTree()
{
    return wxsResourceTree::Get();
}
