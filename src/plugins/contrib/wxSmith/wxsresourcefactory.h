...
* $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/contrib/wxSmith/wxsresourcefactory.h $
*/
...
protected:
    ...
    /** \brief Checking if factory can handle given file as external resource */
    virtual bool OnCanHandleExternal(cb_unused const wxString& FileName)
    {
        return false;
    }

    /** \brief Building external resource object */
    virtual wxsResource* OnBuildExternal(cb_unused const wxString& FileName)
    {
        return 0;
    }
    ...
    virtual int OnResourceTreeIcon(cb_unused int Number)
    {
        return -1;
    }
