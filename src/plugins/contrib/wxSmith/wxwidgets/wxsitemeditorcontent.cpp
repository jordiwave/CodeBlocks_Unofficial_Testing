...
*
* $Revision: 12197 $
* $Id: wxsitemeditorcontent.cpp 12197 2020-08-11 08:14:14Z fuscated $
        ...
        if (FindAbsoluteRect(Item, PosX, PosY, SizeX, SizeY))
        {
            ...
            for (int i = 0; i < DragBoxTypeCnt; ++i)
            {
                ...
                if (i == Top || i == Btm)
                {
                    ...
                    if (i == RightTop || i == Right || i == RightBtm)
                    {
...
wxsItem * wxsItemEditorContent::FindItemAtPos(int PosX, int PosY, wxsItem * SearchIn)
{
    ...
    if (!FindAbsoluteRect(SearchIn, itemPosX, itemPosY, itemSizeX, itemSizeY))
    {
        return 0;
    }
