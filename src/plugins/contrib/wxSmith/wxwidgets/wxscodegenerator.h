...
protected:
    ...
    inline wxsCoderContext* GetCoderContext()
    {
        return m_Context;
    }
    ...
    {
        return m_Context ? m_Context->m_Language : wxsUnknownLanguage;
    }

    /** \brief Getting flags of current coding context */
    inline long GetCoderFlags()
    {
        return m_Context ? m_Context->m_Flags : 0;
    }
