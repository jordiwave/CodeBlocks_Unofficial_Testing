...
wxString wxsFontData::BuildFontCode(const wxString& FontName,wxsCoderContext* Context)
{
    ...
    case wxsCPP:
    {
        ...
        if ( HasFamily )
        {
            if ( Family == wxFONTFAMILY_DECORATIVE ) FamilyStr = _T("wxFONTFAMILY_DECORATIVE");
            else if ( Family == wxFONTFAMILY_ROMAN      ) FamilyStr = _T("wxFONTFAMILY_ROMAN");
            else if ( Family == wxFONTFAMILY_SCRIPT     ) FamilyStr = _T("wxFONTFAMILY_SCRIPT");
            else if ( Family == wxFONTFAMILY_SWISS      ) FamilyStr = _T("wxFONTFAMILY_SWISS");
            else if ( Family == wxFONTFAMILY_MODERN     ) FamilyStr = _T("wxFONTFAMILY_MODERN");
            else if ( Family == wxFONTFAMILY_TELETYPE   ) FamilyStr = _T("wxFONTFAMILY_TELETYPE");
        }

        wxString StyleStr = _T("wxFONTSTYLE_NORMAL");
        if ( HasStyle )
        {
            if ( Style == wxFONTSTYLE_ITALIC ) StyleStr = _T("wxFONTSTYLE_ITALIC");
            else if ( Style == wxFONTSTYLE_SLANT  ) StyleStr = _T("wxFONTSTYLE_SLANT" );
        }

        wxString WeightStr = _T("wxFONTWEIGHT_NORMAL");
        if ( HasWeight )
        {
            if ( Weight == wxFONTWEIGHT_BOLD  ) WeightStr = _T("wxFONTWEIGHT_BOLD");
            else if ( Weight == wxFONTWEIGHT_LIGHT ) WeightStr = _T("wxFONTWEIGHT_LIGHT");
        }
...
bool wxsFontProperty::XmlRead(wxsPropertyContainer* Object,TiXmlElement* Element)
{
    ...
    {
        if ( Val == _T("italic") ) VALUE.Style = wxFONTSTYLE_ITALIC;
        else if ( Val == _T("slant") )  VALUE.Style = wxFONTSTYLE_SLANT;
        else
    ...
    {
        if ( Val == _T("bold") )  VALUE.Weight = wxFONTWEIGHT_BOLD;
        else if ( Val == _T("light") ) VALUE.Weight = wxFONTWEIGHT_LIGHT;
        else
    ...
    {
        if ( Val == _T("decorative") ) VALUE.Family = wxFONTFAMILY_DECORATIVE;
        else if ( Val == _T("roman") )      VALUE.Family = wxFONTFAMILY_ROMAN;
        else if ( Val == _T("script") )     VALUE.Family = wxFONTFAMILY_SCRIPT;
        else if ( Val == _T("swiss") )      VALUE.Family = wxFONTFAMILY_SWISS;
        else if ( Val == _T("modern") )     VALUE.Family = wxFONTFAMILY_MODERN;
        else if ( Val == _T("teletype") )   VALUE.Family = wxFONTFAMILY_TELETYPE;
        else
...
bool wxsFontProperty::XmlWrite(wxsPropertyContainer* Object,TiXmlElement* Element)
{
    ...
    if ( VALUE.HasStyle )
    {
        if ( VALUE.Style == wxFONTSTYLE_ITALIC ) XmlSetString(Element,_T("italic"),_T("style"));
        else if ( VALUE.Style == wxFONTSTYLE_SLANT  ) XmlSetString(Element,_T("slant"), _T("style"));
        else
    ...
    if ( VALUE.HasWeight )
    {
        if ( VALUE.Weight == wxFONTWEIGHT_BOLD  ) XmlSetString(Element,_T("bold"),  _T("weight"));
        else if ( VALUE.Weight == wxFONTWEIGHT_LIGHT ) XmlSetString(Element,_T("light"), _T("weight"));
        else
    ...
    if ( VALUE.HasFamily )
    {
        if ( VALUE.Family == wxFONTFAMILY_DECORATIVE ) XmlSetString(Element,_T("decorative"),_T("family"));
        else if ( VALUE.Family == wxFONTFAMILY_ROMAN      ) XmlSetString(Element,_T("roman"),     _T("family"));
        else if ( VALUE.Family == wxFONTFAMILY_SCRIPT     ) XmlSetString(Element,_T("script"),    _T("family"));
        else if ( VALUE.Family == wxFONTFAMILY_SWISS      ) XmlSetString(Element,_T("swiss"),     _T("family"));
        else if ( VALUE.Family == wxFONTFAMILY_MODERN     ) XmlSetString(Element,_T("modern"),    _T("family"));
        else if ( VALUE.Family == wxFONTFAMILY_TELETYPE   ) XmlSetString(Element,_T("teletype"),  _T("family"));
        else if ( VALUE.Family == wxFONTFAMILY_DEFAULT    ) XmlSetString(Element,_T("default"),   _T("family"));
    }
