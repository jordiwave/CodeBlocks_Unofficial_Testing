                                            ...
                                            if (Flag == _T("wxEXPAND"))
                                            {
                                                ...
                                                if (Flag == _T("wxGROW"))
                                                {
                                                    ...
                                                    if (Flag == _T("wxSHAPED"))
                                                    {
                                                        ...
                                                        if (Flag == _T("wxFIXED_MINSIZE"))
                                                        {
                                                            Flags |= FixedMinSize;
                                                        }
                                                        else
                                                            if (Flag == _T("wxALIGN_CENTER"))
                                                            {
                                                                Flags |= AlignCenterHorizontal | AlignCenterVertical;
                                                            }
                                                            else
                                                                if (Flag == _T("wxALIGN_CENTRE"))
                                                                {
                                                                    Flags |= AlignCenterHorizontal | AlignCenterVertical;
                                                                }
                                                                else
                                                                    if (Flag == _T("wxALIGN_LEFT"))
                                                                    {
                                                                        Flags |= AlignLeft;
                                                                    }
                                                                    else
                                                                        if (Flag == _T("wxALIGN_RIGHT"))
                                                                        {
                                                                            Flags |= AlignRight;
                                                                        }
                                                                        else
                                                                            if (Flag == _T("wxALIGN_TOP"))
                                                                            {
                                                                                Flags |= AlignTop;
                                                                            }
                                                                            else
                                                                                if (Flag == _T("wxALIGN_BOTTOM"))
                                                                                {
                                                                                    Flags |= AlignBottom;
                                                                                }
                                                                                else
                                                                                    if (Flag == _T("wxALIGN_CENTER_HORIZONTAL"))
                                                                                    {
                                                                                        Flags |= AlignCenterHorizontal;
                                                                                    }
                                                                                    else
                                                                                        if (Flag == _T("wxALIGN_CENTRE_HORIZONTAL"))
                                                                                        {
                                                                                            Flags |= AlignCenterHorizontal;
                                                                                        }
                                                                                        else
                                                                                            if (Flag == _T("wxALIGN_CENTER_VERTICAL"))
                                                                                            {
                                                                                                Flags |= AlignCenterVertical;
                                                                                            }
                                                                                            else
                                                                                                if (Flag == _T("wxALIGN_CENTRE_VERTICAL"))
                                                                                                {
                                                                                                    Flags |= AlignCenterVertical;
                                                                                                }
    }
...
wxString wxsSizerFlagsProperty::GetString(long Flags)
{
    ...
    else
    {
        if (Flags & BorderTop)
        {
            Result.Append(_T("wxTOP|"));
        }

        if (Flags & BorderBottom)
        {
            Result.Append(_T("wxBOTTOM|"));
        }

        if (Flags & BorderLeft)
        {
            Result.Append(_T("wxLEFT|"));
        }

        if (Flags & BorderRight)
        {
            Result.Append(_T("wxRIGHT|"));
        }
    }
    ...
    else
    {
        if (Flags & AlignLeft)
        {
            Result.Append(_T("wxALIGN_LEFT|"));
        }

        if (Flags & AlignRight)
        {
            Result.Append(_T("wxALIGN_RIGHT|"));
        }

        if (Flags & AlignTop)
        {
            Result.Append(_T("wxALIGN_TOP|"));
        }

        if (Flags & AlignBottom)
        {
            Result.Append(_T("wxALIGN_BOTTOM|"));
        }

        if (Flags & AlignCenterHorizontal)
        {
            Result.Append(_T("wxALIGN_CENTER_HORIZONTAL|"));
        }

        if (Flags & AlignCenterVertical)
        {
            Result.Append(_T("wxALIGN_CENTER_VERTICAL|"));
        }
    }

    if (Flags & Shaped)
    {
        Result.Append(_T("wxSHAPED|"));
    }

    if (Flags & FixedMinSize)
    {
        Result.Append(_T("wxFIXED_MINSIZE|"));
    }
