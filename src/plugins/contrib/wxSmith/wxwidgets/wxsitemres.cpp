    ...
    switch (GetLanguage())
    {
        case wxsCPP:
        {
            ...
            if (Params.GenHdr)
            {
                ...
                {
                    case NewResourceParams::Private:
                        Scope = _T("\tprivate:\n\n");
                        break;

                    case NewResourceParams::Protected:
                        Scope = _T("\tprotected:\n\n");
                        break;
