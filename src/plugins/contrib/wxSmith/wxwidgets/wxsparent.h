...
*
* $Revision: 12722 $
* $Id: wxsparent.h 12722 2022-02-23 09:31:26Z wh11204 $
...
public:
     ...
     */
    inline bool CanAddChild(wxsItem* Item,bool ShowMessage)
    {
        return OnCanAddChild(Item,ShowMessage);
    }
     ...
     */
    inline bool IsChildPreviewVisible(wxsItem* Child)
    {
        return OnIsChildPreviewVisible(Child);
    }

    /** \brief Ensuring that child item is visible in preview
     * \note This is only a wrapper to OnEnsureChildPreviewVisible
     */
    inline bool EnsureChildPreviewVisible(wxsItem* Child)
    {
        return OnEnsureChildPreviewVisible(Child);
    }
...
protected:
     ...
     */
    virtual bool OnIsChildPreviewVisible(cb_unused wxsItem* Child)
    {
        return true;
    }
     ...
     */
    virtual bool OnEnsureChildPreviewVisible(cb_unused wxsItem* Child)
    {
        return false;
    }
