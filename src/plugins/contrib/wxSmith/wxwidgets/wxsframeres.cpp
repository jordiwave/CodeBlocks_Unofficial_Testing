...
*
* $Revision: 10688 $
* $Id: wxsframeres.cpp 10688 2016-01-22 12:24:56Z mortenmacfly $
* $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/contrib/wxSmith/wxwidgets/wxsframeres.cpp $
*/
...
class wxsFrameResPreview: public wxFrame
{
    public:
        ...
        wxsFrameResPreview(cb_unused wxWindow * Parent, wxsItemResData * Data): m_Data(Data)
        {
