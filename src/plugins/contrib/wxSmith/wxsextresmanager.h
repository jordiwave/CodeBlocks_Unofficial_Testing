...
*
* $Revision: 7109 $
* $Id: wxsextresmanager.h 7109 2011-04-15 11:53:16Z mortenmacfly $
* $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/contrib/wxSmith/wxsextresmanager.h $
*/
...
inline wxsExtResManager * wxsExtRes()
{
    return wxsExtResManager::Get();
}
