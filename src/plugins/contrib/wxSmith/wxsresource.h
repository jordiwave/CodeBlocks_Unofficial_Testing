...
*
* $Revision: 12316 $
* $Id: wxsresource.h 12316 2021-05-03 12:02:13Z fuscated $
...
public:
    ...
    inline const wxString& GetResourceType()
    {
        return m_ResourceType;
    }

    /** \brief Getting GUI */
    inline const wxString& GetGUI()
    {
        return m_GUI;
    }

    /** \brief Getting coding language used inside this resource */
    inline wxsCodingLang GetLanguage()
    {
        return m_Language;
    }

    /** \brief Setting new language */
    inline void SetLanguage(wxsCodingLang Lang)
    {
        m_Language = Lang;
    }

    /** \brief Getting resource name */
    inline const wxString& GetResourceName()
    {
        return m_ResourceName;
    }

    /** \brief Changing resource's name */
    inline void SetResourceName(const wxString& NewName)
    {
    ...
    /** \brief Getting name of declaration file
      ...
      */
    inline wxString GetDeclarationFile()
    {
        return OnGetDeclarationFile();
    }
     ...
     */
    inline wxString GetAppBuildingCode()
    {
        return OnGetAppBuildingCode();
    }
    ...
    inline wxString GetProjectPath()
    {
        return m_Owner ? m_Owner->GetProjectPath() : _T("");
    }

    /** \brief Getting project owning this resource */
    inline wxsProject* GetProject()
    {
        return m_Owner;
    }

    /** \brief Cleaning up before deleting this resource from project */
    inline bool DeleteCleanup(bool ShowDialog=true)
    {
        return OnDeleteCleanup(ShowDialog);
    }
     ...
     */
    virtual bool Rename(const wxString &oldName, const wxString &newName)
    {
        return false;
    }
