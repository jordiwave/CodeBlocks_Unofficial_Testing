...
*
* $Revision: 10874 $
* $Id: wxsgui.h 10874 2016-07-16 20:00:28Z jenslody $
* $HeadURL: https://svn.code.sf.net/p/codeblocks/code/trunk/src/plugins/contrib/wxSmith/wxsgui.h $
*/
...
public:
    ...
    inline wxsProject* GetProject() const
    {
        return m_Project;
    }
     ...
     */
    inline void WriteConfig(TiXmlElement* Node)
    {
        OnWriteConfig(Node);
    }
     ...
     */
    inline bool CheckIfApplicationManaged()
    {
     ...
     */
    inline cbConfigurationPanel* BuildConfigurationPanel(wxWindow* Parent)
    {
        return OnBuildConfigurationPanel(Parent);
    }
     ...
     */
    inline bool CreateApplicationBinding()
    {
        return OnCreateApplicationBinding();
    }

    /** \brief Rebuilding application's code */
    inline void RebuildApplicationCode()
    {
