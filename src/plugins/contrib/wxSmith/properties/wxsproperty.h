...
public:
    ...
    virtual bool PGRead(cb_unused wxsPropertyContainer*  Object,
                        cb_unused wxPropertyGridManager* Grid,
                        cb_unused wxPGId                 Id, cb_unused long Index)
    {
        return false;
    }
    ...
    virtual bool XmlRead(cb_unused wxsPropertyContainer* Object,
                         cb_unused TiXmlElement*         Element)
    {
        return false;
    }
    ...
    virtual bool PropStreamRead(cb_unused wxsPropertyContainer* Object,
                                cb_unused wxsPropertyStream*    Stream)
    {
        return false;
    }
    ...
    inline const wxString& GetPGName()
    {
        return m_PGName;
    }

    /** \brief Getting name of data (Xml and others) entry */
    inline const wxString& GetDataName()
    {
        return m_DataName;
    }
    ...
    void SetHelpString(const wxString &helpStr)
    {
        m_HelpString = helpStr;
    }
protected:
