...
class ConfigPanel: public cbConfigurationPanel
{
    public:
        ...
        {
            return RadioBoxBlockComments->GetSelection();
        }
        ...
        {
            RadioBoxBlockComments->SetSelection(val);
        }
        ...
        {
            return RadioBoxLineComments->GetSelection();
        }
        ...
        {
            RadioBoxLineComments->SetSelection(val);
        }
        // == Doxyfile defaults. ==
        // Project.
        ...
        {
            return TextCtrlProjectNumber->GetValue();
        }
        ...
        {
            TextCtrlProjectNumber->SetValue(val);
        }
        ...
        {
            return TextCtrlOutputDirectory->GetValue();
        }
        ...
        {
            TextCtrlOutputDirectory->SetValue(val);
        }
        ...
        {
            return ChoiceOutputLanguage->GetStringSelection();
        }
        ...
        {
            ChoiceOutputLanguage->SetStringSelection(val);
        }
        ...
        {
            return CheckBoxUseAutoVersion->GetValue();
        }
        ...
        bool GetExtractAll()
        {
            return CheckBoxExtractAll->GetValue();
        }
        ...
        {
            CheckBoxExtractAll->SetValue(val);
        }
        ...
        {
            return CheckBoxExtractPrivate->GetValue();
        }
        ...
        {
            CheckBoxExtractPrivate->SetValue(val);
        }
        ...
        {
            return CheckBoxExtractStatic->GetValue();
        }
        ...
        {
            CheckBoxExtractStatic->SetValue(val);
        }
        // Warnings.
        ...
        bool GetWarnings()
        {
            return CheckBoxWarnings->GetValue();
        }
        ...
        {
            return CheckBoxWarnIfDocError->GetValue();
        }
        ...
        {
            CheckBoxWarnIfDocError->SetValue(val);
        }
        ...
        {
            return CheckBoxWarnIfUndocumented->GetValue();
        }
        ...
        {
            CheckBoxWarnIfUndocumented->SetValue(val);
        }
        ...
        {
            return CheckBoxWarnNoParamdoc->GetValue();
        }
        ...
        {
            CheckBoxWarnNoParamdoc->SetValue(val);
        }
        ...
        {
            return CheckBoxAlphabeticalIndex->GetValue();
        }
        ...
        {
            CheckBoxAlphabeticalIndex->SetValue(val);
        }
        // Output.
        ...
        {
            return CheckBoxGenerateHTML->GetValue();
        }
        ...
        {
            CheckBoxGenerateHTML->SetValue(val);
        }
        ...
        {
            return CheckBoxGenerateHTMLHelp->GetValue();
        }
        ...
        {
            CheckBoxGenerateHTMLHelp->SetValue(val);
        }
        ...
        bool GetGenerateCHI()
        {
            return CheckBoxGenerateCHI->GetValue();
        }
        ...
        {
            CheckBoxGenerateCHI->SetValue(val);
        }
        ...
        bool GetBinaryTOC()
        {
            return CheckBoxBinaryTOC->GetValue();
        }
        ...
        {
            CheckBoxBinaryTOC->SetValue(val);
        }
        ...
        {
            return CheckBoxGenerateLatex->GetValue();
        }
        ...
        {
            CheckBoxGenerateLatex->SetValue(val);
        }
        ...
        bool GetGenerateRTF()
        {
            return CheckBoxGenerateRTF->GetValue();
        }
        ...
        {
            CheckBoxGenerateRTF->SetValue(val);
        }
        ...
        bool GetGenerateMan()
        {
            return CheckBoxGenerateMan->GetValue();
        }
        ...
        {
            CheckBoxGenerateMan->SetValue(val);
        }
        ...
        bool GetGenerateXML()
        {
            return CheckBoxGenerateXML->GetValue();
        }
        ...
        {
            CheckBoxGenerateXML->SetValue(val);
        }
        ...
        {
            return CheckBoxGenerateAutogenDef->GetValue();
        }
        ...
        {
            CheckBoxGenerateAutogenDef->SetValue(val);
        }
        ...
        {
            return CheckBoxGeneratePerlMod->GetValue();
        }
        ...
        {
            CheckBoxGeneratePerlMod->SetValue(val);
        }
        // Pre-processor.
        ...
        {
            return CheckBoxEnablePreprocessing->GetValue();
        }
        ...
        {
            CheckBoxEnablePreprocessing->SetValue(val);
        }
        // Dot.
        ...
        bool GetHaveDot()
        {
            return CheckBoxHaveDot->GetValue();
        }
        /** Set CheckBoxHaveDot
         * \param val New value to set
         */
        ...
        {
            return CheckBoxClassDiagrams->GetValue();
        }
        ...
        {
            CheckBoxClassDiagrams->SetValue(val);
        }
        // Paths.
        ...
        {
            return TextCtrlPathDoxygen->GetValue();
        }
        ...
        {
            TextCtrlPathDoxygen->SetValue(val);
        }
        ...
        {
            return TextCtrlPathDoxywizard->GetValue();
        }
        ...
        {
            TextCtrlPathDoxywizard->SetValue(val);
        }
        ...
        wxString GetPathHHC()
        {
            return TextCtrlPathHHC->GetValue();
        }
        /** Set TextCtrlPathHHC
         * \param val New value to set
         */
        ...
        wxString GetPathDot()
        {
            return TextCtrlPathDot->GetValue();
        }
        /** Set TextCtrlPathDot
         * \param val New value to set
         */
        ...
        {
            return TextCtrlPathCHMViewer->GetValue();
        }
        ...
        {
            TextCtrlPathCHMViewer->SetValue(val);
        }
        // General Options
        ...
        {
            return CheckBoxOverwriteDoxyfile->GetValue();
        }
        ...
        {
            CheckBoxOverwriteDoxyfile->SetValue(val);
        }
        ...
        {
            return CheckBoxPromptBeforeOverwriting->GetValue();
        }
        ...
        {
            CheckBoxPromptBeforeOverwriting->SetValue(val);
        }
        ...
        bool GetUseAtInTags()
        {
            return CheckBoxUseAtInTags->GetValue();
        }
        ...
        {
            CheckBoxUseAtInTags->SetValue(val);
        }
        ...
        {
            return CheckBoxLoadTemplate->GetValue();
        }
        ...
        {
            CheckBoxLoadTemplate->SetValue(val);
        }
        ...
        {
            return CheckBoxUseInternalViewer->GetValue();
        }
        ...
        {
            CheckBoxUseInternalViewer->SetValue(val);
        }
        ...
        bool GetRunHTML()
        {
            return CheckBoxRunHTML->GetValue();
        }
        /** Set CheckBoxRunHTML
         * \param val New value to set
         */
        ...
        bool GetRunCHM()
        {
            return CheckBoxRunCHM->GetValue();
        }
        /** Set CheckBoxRunCHM
         * \param val New value to set
         */
