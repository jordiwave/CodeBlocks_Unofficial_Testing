 ...
 *
 * $Revision: 71 $
 * $Id: tokenizer.cpp 71 2022-08-15 20:23:03Z pecanh $
 * $HeadURL: http://svn.code.sf.net/p/cb-clangd-client/code/trunk/clangd_client/src/codecompletion/parser/tokenizer.cpp $
 */
