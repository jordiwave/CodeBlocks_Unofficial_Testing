...
// ----------------------------------------------------------------------------
{
    ...
    private:
        ...
        // ----------------------------------------------------------------------------
        std::vector<CCToken> m_CompletionTokens;
        std::vector<CCToken> m_HoverTokens;
        ...
        bool IsOldCC_Enabled()
        {
            ...
            if (not wxFileExists(pluginDir + wxFILE_SEP_PATH + "codecompletion.dll"))
            {
            ...
            if (not wxFileExists(pluginDir + wxFILE_SEP_PATH + "libcodecompletion.so"))
            {
                m_OldCC_enabled = false;
            }
