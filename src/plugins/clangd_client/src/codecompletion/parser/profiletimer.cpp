 ...
 *
 * $Revision: 63 $
 * $Id: profiletimer.cpp 63 2022-05-20 17:21:14Z pecanh $
 * $HeadURL: http://svn.code.sf.net/p/cb-clangd-client/code/trunk/clangd_client/src/codecompletion/parser/profiletimer.cpp $
 */
