...
public:
    ...
    {
        return IsOpen(filename);    // synonym of IsOpen()
    }
    ...
    {
        return GetBuiltinEditor(IsOpen(filename));
    }
    cbEditor* GetBuiltinEditor(int index)
    {
        return GetBuiltinEditor(GetEditor(index));
    }
    cbEditor* GetBuiltinEditor(const wxString& filename)
    {
        return IsBuiltinOpen(filename);    // synonym of IsBuiltinOpen()
    }
    cbEditor* GetBuiltinActiveEditor()
    {
        return GetBuiltinEditor(GetActiveEditor());
    }
