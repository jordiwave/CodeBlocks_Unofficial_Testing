...
BUILD_BITS=$1
[ -f  "src/devel31/bin/codeblocks" ] && BUILD_BITS=64
...
if { !  {  
        ...
        [ -f "src/devel31_$BUILD_BITS/libcodeblocks.dll" ]     &&
    ...
    [ ! -f "src/devel31_$BUILD_BITS/libcodeblocks.dll" ]         && echo "|                   |        Missing src/devel31_$BUILD_BITS/libcodeblocks.dll!         |                  |"
...
# -------------------------------------------------------------------------------------------------------
count=$(ls -1 src/devel31_$BUILD_BITS/share/CodeBlocks/plugins/*.a 2>/dev/null | wc -l)
if [ $count != 0 ] ; then
    PrevDirectory=$PWD
    cd "src/devel31_$BUILD_BITS/share/CodeBlocks/plugins"
