...
#define MyAppVersion "SVN_12487"
#define MyAppExeName "NSW_SIMULATOR.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{CC886CDC-0D00-4485-AC9A-3D81802681C2}
AppName=Code::Blocks
AppVerName=Code::Blocks {#MyAppVersion}
AppPublisher=Code::Blocks
DefaultDirName={pf}\CodeBlocks
DefaultGroupName=CodeBlocks
LicenseFile=..\..\COPYING
OutputBaseFilename=CodeBlocks-{#MyAppVersion}
...
WizardImageFile=setup_1.bmp
WizardSmallImageFile=setup_1_small.bmp
InfoAfterFile=
...
[Files]
Source: ..\output\{#MyAppExeName}; DestDir: {app}; Flags: ignoreversion; Components: ProgramFiles
Source: ..\output\codeblocks.dll; DestDir: {app}; Components: ProgramFiles
Source: {#MyAppExeName}.manifest; DestDir: {app}; Components: ProgramFiles
...
[Icons]
Name: {group}\CodeBlocks; Filename: {app}\{#MyAppExeName}; IconIndex: 0; WorkingDir: {app}; Comment: Code::Blocks IDE; Components: ProgramFiles
Name: {userdesktop}\CodeBlocks; Filename: {app}\{#MyAppExeName}; Tasks: desktopicon; IconIndex: 0; WorkingDir: {app}; Comment: Code::Blocks IDE; Components: ProgramFiles
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\CodeBlocks; Filename: {app}\{#MyAppExeName}; Tasks: quicklaunchicon; IconIndex: 0; WorkingDir: {app}; Comment: Code::Blocks IDE; Components: ProgramFiles
...
;[UninstallRun]
;Filename: {app}\{#MyAppExeName}; Parameters: --clear-configuration; WorkingDir: {app}

;[UninstallDelete]
;Type: files; Name: "{app}\CMS_Support_Application\CSA_log.*"
