...
#                                                                                         #
# 2) Update the following or check out the Build_NSIS_64bit.bat                           #
#       file:                                                                             #
#    * BUILD_TYPE for 32 or 64 bit                                                        #
#    * BUILD_TYPE for 32 or 64 bit                                                        #
#                                                                                         #
# 3) run NSIS using this command line or via the MakeNSISW.exe GUI                        #
...
###############################################################
#      NSIS PAGE GUI Defines (SEE NSIS and MUI docs)          #
###############################################################
...
!define TEXT_SETUPTYPE_MINIMAL_TITLE  "Minimal: Important plugins, important lexers"
!define TEXT_SETUPTYPE_STANDARD_TITLE "Standard: Core plugins, core tools, and core lexers"
!define TEXT_SETUPTYPE_COMPLETE_TITLE "Full: All plugins, all tools, just everything"
!define TEXT_SETUPTYPE_EDIT_ONLY_TITLE "Editor: Code::Blocks as editor only (all lexers)"
...
InstType "${TEXT_SETUPTYPE_COMPLETE_TITLE}"     # 1
InstType "${TEXT_SETUPTYPE_STANDARD_TITLE}"     # 2 
InstType "${TEXT_SETUPTYPE_MINIMAL_TITLE}"      # 3
InstType "${TEXT_SETUPTYPE_EDIT_ONLY_TITLE}"    # 4 Select custom then this in the drop down.
